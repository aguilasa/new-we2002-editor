...
A [WTE-TASK-29](/docs/tasks/29-camisa-e-bandeira-2d.md) mediu e **refutou**: o
...
[`progresso.md`](/docs/tasks/progresso.md) diz, na abertura, que
"divergência entre os dois se resolve **a favor do plano**". Hoje essa regra
aponta para a versão errada.

É a mesma forma da [CORR-WTE-072](/docs/tasks/CORR-WTE-072.md): documento que
