...
[WTE-TASK-17](/docs/tasks/17-transpilador-da-camada-de-dados.md) abre assim:
...
### Arquivo: `docs/tasks/17-transpilador-da-camada-de-dados.md`
...
| Arquivo | Ação |
|---|---|
| `docs/tasks/17-transpilador-da-camada-de-dados.md` | modificar |
