...
| `docs/tasks/PAR-TASK-08.md` | o item 4 e o Log |
...
- `docs/tasks/CORR-WTE-133.md` — este Log e o diagnóstico
- `docs/tasks/correcoes-progresso.md` — o `[x]` e a data
- `CLAUDE.md` — a armadilha das duas cópias, com o `cmp` que a detecta
- `docs/PARIDADE-FUNCIONAL.md` e `docs/tasks/PAR-TASK-08.md` — o item 4 da §8.9
