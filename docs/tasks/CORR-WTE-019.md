...
3. **`docs/tasks/progresso.md`**, em "Pendências externas": "**Assets não
...
| `docs/tasks/progresso.md` | modificar (Pendências externas) |

## Verificação

- [ ] `grep -n "816.880\|816880" docs/PLAN-WTE-LAZARUS.md .gitignore docs/tasks/progresso.md`
      acha a exceção nos três
- [ ] `grep -n "wte/re/dfm/README" docs/PLAN-WTE-LAZARUS.md .gitignore docs/tasks/progresso.md`
