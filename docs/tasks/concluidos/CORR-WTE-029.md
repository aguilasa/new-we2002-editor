...
O Log de Execução da [WTE-TASK-16](/docs/tasks/concluidos/16-gerador-de-tabelas.md) afirma
...
### Arquivo: `docs/tasks/concluidos/16-gerador-de-tabelas.md`
...
| Arquivo | Ação |
|---|---|
| `docs/tasks/concluidos/16-gerador-de-tabelas.md` | modificar |

## Verificação

- [ ] `grep -n 'commit próprio\|commit separado\|ver abaixo' docs/tasks/concluidos/16-gerador-de-tabelas.md`
      não devolve nada
...
**Arquivos criados/modificados:** `docs/tasks/concluidos/16-gerador-de-tabelas.md`
