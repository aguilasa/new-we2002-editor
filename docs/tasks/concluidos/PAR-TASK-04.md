...
status: done
source_of_truth: "/docs/PARIDADE-FUNCIONAL.md#8.4"
phase: null
...
- `docs/tasks/concluidos/PAR-TASK-04.md` — este Log e o `status`
...
**Adendo da [CORR-WTE-128](/docs/tasks/concluidos/CORR-WTE-128.md), 2026-08-29.** O item 1
tinha sido medido em 2026-08-28, no dia em que a
[CORR-WTE-123](/docs/tasks/concluidos/CORR-WTE-123.md) criou o `tools/par/`, e ficou sem
