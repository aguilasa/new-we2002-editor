...
[WTE-TASK-26](/docs/tasks/concluidos/26-handlers-de-edicao.md) —, mas ao fechar o modal
...
o primeiro é da [WTE-TASK-28](/docs/tasks/concluidos/28-import-de-mcr.md) e o segundo da
...
[CORR-WTE-044](/docs/tasks/concluidos/CORR-WTE-044.md) desfez o ciclo do gate e como a
[WTE-TASK-26](/docs/tasks/concluidos/26-handlers-de-edicao.md) entregou o critério de byte
para cá.
...
> [CORR-WTE-109](/docs/tasks/concluidos/CORR-WTE-109.md) em 2026-08-25: o `wte.exe` não a
...
A [WTE-TASK-26](/docs/tasks/concluidos/26-handlers-de-edicao.md) edita **em memória** e não
...
forma que a [CORR-WTE-044](/docs/tasks/concluidos/CORR-WTE-044.md) desfez para o gate.
...
- **Arquivos da segunda metade:**
  ...
  - modificados: `wte/src/we2002_estado.pas` (os dois remendos),
    ...
    `docs/tasks/concluidos/25-handlers-de-carga.md`,
    `docs/tasks/concluidos/33-slots-de-master-league.md`, `docs/PLAN-WTE-LAZARUS.md` §4.4
...
- **Resumo do que foi feito:**
  ...
  **O destino de Master League grava outra coisa, e é isso que separa as duas
  ...
  [WTE-TASK-33](/docs/tasks/concluidos/33-slots-de-master-league.md) enche.
...
- **Resumo do que foi feito:**
  ...
  **A primeira régua não tinha porta automática, e ninguém tinha notado.** A
  [CORR-WTE-047](/docs/tasks/concluidos/CORR-WTE-047.md) deu ao `cmp` um `--fundir-cmp`
...
- **A ROM europeia não hospeda este grupo, e agora está medido aqui.** O mesmo
  ...
  [CORR-WTE-044](/docs/tasks/concluidos/CORR-WTE-044.md) já tinha medido — e a caixa de
...
- **Arquivos criados/modificados:**
  ...
  - `docs/tasks/concluidos/progresso.md`, e esta task
...
- **Resumo do que foi feito:**
  ...
  **A estrutura do maior handler do grupo está recuperada.** 2.268 bytes, e ele
  ...
  [CORR-WTE-061](/docs/tasks/concluidos/CORR-WTE-061.md) já tinha medido como largura por
...
- **O `boton_dialogo_texClick` continua `aberto`, de propósito.** Portá-lo pela
  ...
  [WTE-TASK-29](/docs/tasks/concluidos/29-camisa-e-bandeira-2d.md). Na janela do port o
...
- **Arquivos criados/modificados:**
  ...
  - `wte/re/gravacao-controle.md`, `wte/re/offsets-novos.md`,
    ...
    `wte/re/fase-2.md`
  - `docs/PLAN-WTE-LAZARUS.md` §4.4, `docs/tasks/concluidos/progresso.md`, e esta task
