...
e é o que a §8.10 e a [PAR-TASK-09](/docs/tasks/concluidos/PAR-TASK-09.md) descrevem
...
### Arquivo: `docs/PARIDADE-FUNCIONAL.md` e `docs/tasks/concluidos/PAR-TASK-09.md`
...
| `docs/tasks/concluidos/PAR-TASK-09.md` | modificar — o Log |
...
- `docs/tasks/concluidos/CORR-WTE-140.md` — a linha que anunciava a captura inexistente
