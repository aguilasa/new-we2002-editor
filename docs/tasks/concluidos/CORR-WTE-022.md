...
| `docs/tasks/concluidos/11-app-com-a-casca-completa.md` | modificar (Log) |
...
- [ ] `grep -n "401a2e" wte/src/wtemain.pas docs/tasks/concluidos/11-app-com-a-casca-completa.md`
...
- `docs/tasks/concluidos/11-app-com-a-casca-completa.md` (Log)
