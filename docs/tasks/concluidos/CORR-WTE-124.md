...
[PAR-TASK-02](/docs/tasks/concluidos/PAR-TASK-02.md) item 3. O `golden_check.sh` em modo
...
| `docs/tasks/concluidos/PAR-TASK-02.md` | modificar — o item 3 e o Log |
...
seu — é a mesma lacuna que a [CORR-WTE-123](/docs/tasks/concluidos/CORR-WTE-123.md) fechou
...
- `docs/tasks/concluidos/PAR-TASK-02.md` — o item 3, a Definição de pronto, o `status` e o
  adendo no Log
- `docs/tasks/concluidos/progresso.md` — a linha da PAR-TASK-02 no anexo
