...
A varredura pegou `docs/tasks/concluidos/23-formato-da-spec.md:79` — a tabela "Arquivos a
...
- `wte/tools/README.md`
- `docs/tasks/concluidos/23-formato-da-spec.md` (sítio achado na varredura)
