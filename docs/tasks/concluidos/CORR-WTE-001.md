...
`docs/tasks/concluidos/01-ferramental.md` fechou no commit `2aec9cb`: os seis itens do
...
| Fonte | O que afirma |
|---|---|
| `docs/tasks/concluidos/01-ferramental.md` linha 8 | `status: pendente` |
| `docs/tasks/concluidos/progresso.md` linha 16 | `✅ Concluído` · `2026-08-05` |
| `docs/tasks/concluidos/01-ferramental.md` linhas 115-120 | os seis critérios em `[x]` |
...
### Arquivo: `docs/tasks/concluidos/01-ferramental.md`
...
| `docs/tasks/concluidos/01-ferramental.md` | modificar |

## Verificação

- [x] `grep '^status:' docs/tasks/concluidos/01-ferramental.md` devolve `concluído`
...
- `docs/tasks/concluidos/01-ferramental.md` (modificado)
- `docs/tasks/concluidos/correcoes-progresso.md` (modificado)
- `docs/tasks/concluidos/CORR-WTE-001.md` (modificado)
