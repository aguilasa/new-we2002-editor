...
da [WTE-TASK-25](/docs/tasks/concluidos/25-handlers-de-carga.md). A spec dele fecha assim:
...
A [WTE-TASK-26](/docs/tasks/concluidos/26-handlers-de-edicao.md) fechou **sem portá-lo**, e
