...
status: done
source_of_truth: "/docs/PARIDADE-FUNCIONAL.md#8.2"
phase: null
...
- [x] `CMD_DEFAULT_NUMBERS` e conferir que o `number` do jogador seguiu —
      ...
      [CORR-WTE-124](/docs/tasks/concluidos/CORR-WTE-124.md);
...
- [x] Divergência fora de `405724..405739` registrada como CORR, com a faixa e o
      offset simbólico — foi a [CORR-WTE-124](/docs/tasks/concluidos/CORR-WTE-124.md)
- [x] `roms/` intocada

## Log de Execução

**Executado em:** 2026-08-28 — parcial, 2 de 3 itens. **Fechada em
2026-08-29**, quando a [CORR-WTE-124](/docs/tasks/concluidos/CORR-WTE-124.md) corrigiu o
terceiro.
...
família do verde vazio da [PAR-TASK-01](/docs/tasks/concluidos/PAR-TASK-01.md), por outra
causa.
...
> [CORR-WTE-124](/docs/tasks/concluidos/CORR-WTE-124.md). Um roteiro que use só o ponto
...
- `docs/tasks/concluidos/CORR-WTE-124.md` — o achado do item 3
- `docs/tasks/concluidos/correcoes-progresso.md` — a linha e o checklist da CORR
- `docs/tasks/concluidos/PAR-TASK-02.md` — este Log

**Adendo da [CORR-WTE-124](/docs/tasks/concluidos/CORR-WTE-124.md), 2026-08-29.** O item 3
...
**Adendo da [CORR-WTE-126](/docs/tasks/concluidos/CORR-WTE-126.md), 2026-08-29.** Os itens
1 e 2 tinham sido medidos em 2026-08-28, no mesmo dia em que a
[CORR-WTE-123](/docs/tasks/concluidos/CORR-WTE-123.md) criou o `tools/par/`, e ficaram sem
