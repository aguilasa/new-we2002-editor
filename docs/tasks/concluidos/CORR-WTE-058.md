...
A [WTE-TASK-25](/docs/tasks/concluidos/25-handlers-de-carga.md) removeu, de propósito e com
...
[`progresso.md`](/docs/tasks/concluidos/progresso.md) lista quatro ferramentas da
...
- `docs/tasks/concluidos/progresso.md` — `src/impl/`, `src/we2002_estado.pas`,
