...
[WTE-TASK-19](/docs/tasks/concluidos/19-os-50-offsets-restantes.md) ainda em aberto, e
isso foi **ordem, não resultado**: nenhum dos seis critérios daqui toca o
oráculo A. O registro dessa decisão mora no
[`progresso.md`](/docs/tasks/concluidos/progresso.md), na nota *"A WTE-TASK-20 foi
...
[WTE-TASK-29](/docs/tasks/concluidos/29-camisa-e-bandeira-2d.md). O que **não** pode
...
[CORR-WTE-109](/docs/tasks/concluidos/CORR-WTE-109.md) em 2026-08-25.)*
...
- **Arquivos criados/modificados:**
  ...
  | `docs/tasks/concluidos/20-round-trip-headless.md` | corrigido: a premissa do codec e os caminhos dos arquivos |
