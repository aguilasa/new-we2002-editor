...
[WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md), fecha assim:

> *Decisão:* corrigir o enunciado da fase 6 para dizer `ed.exe` onde hoje diz
> "o editor". A [WTE-TASK-34](/docs/tasks/concluidos/34-bateria-golden-completa.md) já foi
...
> A [WTE-TASK-34](/docs/tasks/concluidos/34-bateria-golden-completa.md) já foi
...
- [x] `grep -n "falta conferir" docs/tasks/concluidos/35-divergencias-deliberadas.md` sai vazio
...
[CORR-WTE-105](/docs/tasks/concluidos/CORR-WTE-105.md), no mesmo lote em que a
[CORR-WTE-104](/docs/tasks/concluidos/CORR-WTE-104.md) fez a medição — e a 105 supôs que o
...
Aberta a [CORR-WTE-109](/docs/tasks/concluidos/CORR-WTE-109.md), com o caminho barato de
medir a pergunta geral (o próprio `gravacao-controle`, rodado duas vezes), e a
entrada da task 35 aponta para ela.

**Arquivos criados/modificados:**

- `docs/tasks/concluidos/35-divergencias-deliberadas.md` — a decisão, com o resultado
- `docs/tasks/concluidos/CORR-WTE-109.md` — criada, a discrepância maior
- `docs/tasks/concluidos/correcoes-progresso.md` — o `[x]` da 108 e a linha da 109
