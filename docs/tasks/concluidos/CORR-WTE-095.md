...
Isso foi medido pela [WTE-TASK-32](/docs/tasks/concluidos/32-preco-do-jogador.md) e o port
...
[WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md) como divergência
...
[WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md) com as três réguas.
...
| `docs/tasks/concluidos/35-divergencias-deliberadas.md` | modificado — a entrada nova, com as três réguas |
