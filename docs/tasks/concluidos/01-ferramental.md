...
| Arquivo | Ação |
|---|---|
| `docs/tasks/concluidos/progresso.md` | modificar (status) |
...
- **Arquivos criados/modificados:**
  ...
  - `docs/tasks/concluidos/01-ferramental.md` — corrigido (`fpc-src` → `fpc-source`,
    JDK 21) + este log
  - `docs/tasks/concluidos/progresso.md` — status, "Concluída em", "Revisado em"
