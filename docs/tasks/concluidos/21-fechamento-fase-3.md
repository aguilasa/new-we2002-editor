...
- [x] Fração gerada medida e comparada com a tese da §4.5
      ...
      [CORR-WTE-051](/docs/tasks/concluidos/CORR-WTE-051.md), que pôs a mesma régua
...
- **Arquivos criados/modificados:**
  ...
  | `wte/tools/README.md`, `docs/tasks/concluidos/progresso.md` | o script novo e o arquivo novo |
...
- **Problemas encontrados:**
  ...
  *(Os três números são de linha **útil**, que era a régua da contagem naquele
  momento; a [CORR-WTE-051](/docs/tasks/concluidos/CORR-WTE-051.md) trocou a régua
