...
[WTE-TASK-09](/docs/tasks/concluidos/09-fechamento-fase-1.md) já tem no seu quadro de
...
| `docs/tasks/concluidos/progresso.md` | modificar — texto da pendência externa |

## Verificação

- [x] `grep -n "binário original em espanhol" docs/PLAN-WTE-LAZARUS.md
      docs/tasks/concluidos/progresso.md` mostra as duas passagens já com a rota interna
...
- `docs/tasks/concluidos/progresso.md` — texto da pendência externa
