...
[WTE-TASK-24](/docs/tasks/concluidos/24-ghidra-convencao-borland.md) diz:
...
### Arquivo: `docs/tasks/concluidos/24-ghidra-convencao-borland.md`
...
| Arquivo | Ação |
|---|---|
| `docs/tasks/concluidos/24-ghidra-convencao-borland.md` | modificar |
...
- `docs/tasks/concluidos/07-unidades-duvidosas.md` — *"o binário importa 322 símbolos de
...
| Arquivo | Ação |
|---|---|
| `docs/tasks/concluidos/24-ghidra-convencao-borland.md` | modificado — 267 na seção 4, com a conta por DLL |
