...
> [WTE-TASK-30](/docs/tasks/concluidos/30-handlers-auxiliares.md) mediu em 2026-08-21 que
> três handlers do grupo `auxiliar` **gravam na imagem** e ficaram sem dono. Eles
> estavam na [CORR-WTE-081](/docs/tasks/concluidos/CORR-WTE-081.md), que fechou em
...
- [x] 96 entradas no índice, nenhuma `aberto` — **96 de 96 com veredito
      ...
      [WTE-TASK-32](/docs/tasks/concluidos/32-preco-do-jogador.md) entregou os três que
...
- [x] Todo `não portado` com justificativa de escopo — são **dois**,
      ...
      [WTE-TASK-37](/docs/tasks/concluidos/37-reconferencia-de-ui.md); manter `aberto`
...
- **Resumo do que foi feito:**
  ...
  **Os 16 `aberto`, e o que segura cada grupo.** Doze deles **já têm corpo
  ...
  |---:|---|---|
  | 2 | `jugador.etiqprecioClick`, `jugador.casilla_precioKeyPress` | tudo — nem spec têm. São da [WTE-TASK-32](/docs/tasks/concluidos/32-preco-do-jogador.md) |
...
- **Problemas encontrados:**
  ...
  **O `golden-06-textura` reprovou nos dois lados na primeira corrida, e a
  ...
  [CORR-WTE-080](/docs/tasks/concluidos/CORR-WTE-080.md), que é falha de tempo. Não era: o
  ...
  **A lição é para a
  [WTE-TASK-34](/docs/tasks/concluidos/34-bateria-golden-completa.md), que vai versionar a
...
[WTE-TASK-19](/docs/tasks/concluidos/19-os-50-offsets-restantes.md) — *"os offsets que o
...
[CORR-WTE-083](/docs/tasks/concluidos/CORR-WTE-083.md), com as duas rotas possíveis e a
...
- **Arquivos criados/modificados:**
  ...
  - criados: `wte/tools/check_fase4.py`, `wte/tools/test_check_fase4.py`,
    ...
    `docs/tasks/concluidos/CORR-WTE-083.md`
  - modificados: `docs/tasks/concluidos/progresso.md`, `docs/PLAN-WTE-LAZARUS.md`, e na
    segunda passagem `docs/tasks/concluidos/correcoes-progresso.md` e
...
- **Arquivos criados/modificados na terceira passagem:**
  ...
  - modificados: `wte/tools/check_fase4.py`, `wte/tools/test_check_fase4.py`,
    ...
    `docs/tasks/concluidos/progresso.md`, as sete specs acima, e os gerados
...
|---|---|---:|
| [089](/docs/tasks/concluidos/CORR-WTE-089.md) | vereditos presos por "nada exercita o corpo" enquanto a bateria golden os exercitava | 3 |
| [090](/docs/tasks/concluidos/CORR-WTE-090.md) | `aberto` guardando decisão já tomada, ou de outra fase | 3 |
| [091](/docs/tasks/concluidos/CORR-WTE-091.md) | o `Original ` da ficha, preso por ciclo de `uses` | 2 |
| [092](/docs/tasks/concluidos/CORR-WTE-092.md) | dois handlers sem estímulo — o ramo do reserva e o arrasto | 2 |
| [093](/docs/tasks/concluidos/CORR-WTE-093.md) | os dois últimos corpos fora de preço | 2 |
...
a [CORR-WTE-081](/docs/tasks/concluidos/CORR-WTE-081.md) já classificou isso como trabalho
...
[WTE-TASK-32](/docs/tasks/concluidos/32-preco-do-jogador.md), dona dos três últimos
