...
status: done
source_of_truth: "/docs/PLAN-WTE-LAZARUS.md#5.2"
...
| `grabar_memoryClick` | `0x0040f69c` | escreve `.mcr` — **já implementado** na [WTE-TASK-27](/docs/tasks/concluidos/27-handlers-de-gravacao.md), e o layout de saída dele é insumo daqui |
...
[WTE-TASK-27](/docs/tasks/concluidos/27-handlers-de-gravacao.md) — a gravação lá, a origem
...
[WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md) decidir.
