...
[WTE-TASK-20](/docs/tasks/concluidos/20-round-trip-headless.md) justifica por que a task
...
O texto, em `docs/tasks/concluidos/20-round-trip-headless.md:25-38`:
...
### Arquivo: `docs/tasks/concluidos/20-round-trip-headless.md`
...
| Arquivo | Ação |
|---|---|
| `docs/tasks/concluidos/20-round-trip-headless.md` | modificar |

## Verificação

- [x] o enunciado não afirma status de outra tarefa que o `progresso.md`
      contradiga — `grep -n "Bloqueado" docs/tasks/concluidos/20-round-trip-headless.md`
      sai vazio (`rc=1`)
...
- [x] nenhuma célula do `progresso.md` alterada — `git status --short
      docs/tasks/concluidos/progresso.md` vazio
...
alvo. Ficou só a [WTE-TASK-29](/docs/tasks/concluidos/29-camisa-e-bandeira-2d.md), que o
`progresso.md` já declara dona da região da camisa.

**Arquivos criados/modificados:**

- `docs/tasks/concluidos/20-round-trip-headless.md` — a seção "A dependência da
