...
A [CORR-WTE-104](/docs/tasks/concluidos/CORR-WTE-104.md) mediu, em 2026-08-25, que o
...
A [CORR-WTE-108](/docs/tasks/concluidos/CORR-WTE-108.md) conferiu o plano e o achou limpo.
...
[CORR-WTE-101](/docs/tasks/concluidos/CORR-WTE-101.md) — número que migra de um documento
...
- **Algum troca** → a frase fica, ganha o caminho nomeado, e vira entrada da
  [WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md) com o offset.
...
| `docs/tasks/concluidos/19-os-50-offsets-restantes.md` | modificar |
...
varredura achou `docs/tasks/concluidos/20-round-trip-headless.md:95` e — o que mais
...
- `docs/tasks/concluidos/19-os-50-offsets-restantes.md`, `20-round-trip-headless.md`,
