...
- **Resumo do que foi feito:**
  ...
  **E a guarda tem duas cláusulas, das quais só uma trabalha aqui** — medido
  pela [CORR-WTE-120](/docs/tasks/concluidos/CORR-WTE-120.md), porque este parágrafo
...
- **Arquivos criados/modificados:**
  ...
  - `docs/PLAN-WTE-LAZARUS.md` — a §11 inteira, e a linha de estado do
    ...
    concluídas
  - `docs/tasks/concluidos/progresso.md` — a linha da tabela e os cinco itens da fase 7
  - este arquivo
...
[CORR-WTE-116](/docs/tasks/concluidos/CORR-WTE-116.md) em 2026-08-25; a receita anterior
punha o `re/` irmão do **arquivo**, e assim não reproduz.)*

Quem conserta é a [WTE-TASK-39](/docs/tasks/concluidos/39-empacotamento.md), que é dona da
