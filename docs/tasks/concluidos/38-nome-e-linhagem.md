...
| `docs/tasks/concluidos/39-empacotamento.md` | modificar — os nomes decididos e o inventário da renomeação |
| `docs/tasks/concluidos/40-verificacao-final.md` | modificar — o defeito que já espera a condição 3 |
...
- **Arquivos criados/modificados:** conferido contra `git show --stat`.
  ...
  `docs/tasks/concluidos/progresso.md`, este arquivo, e **os dois repasses**:
  `docs/tasks/concluidos/39-empacotamento.md` e `docs/tasks/concluidos/40-verificacao-final.md`.
...
- **Problemas encontrados:**
  ...
  *(Até 2026-08-25 esta receita punha o `re/` irmão do **arquivo**, e o código
  ...
  [CORR-WTE-116](/docs/tasks/concluidos/CORR-WTE-116.md). Quem a seguisse ao pé da letra
