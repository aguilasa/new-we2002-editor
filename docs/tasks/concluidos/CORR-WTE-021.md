...
### Arquivo: `docs/tasks/concluidos/10-conversor-dfm-para-lfm.md`
...
| Arquivo | Ação |
|---|---|
| `docs/tasks/concluidos/10-conversor-dfm-para-lfm.md` | modificar |
| `docs/tasks/concluidos/12-comparacao-visual.md` | modificar |

## Verificação

- [ ] `grep -n "WTE-TASK-11" docs/tasks/concluidos/10-conversor-dfm-para-lfm.md` não
      aparece mais no critério dos blobs (a nota do `retrace` no Log continua)
- [ ] `grep -n "118" docs/tasks/concluidos/12-comparacao-visual.md` acha o critério
      herdado
...
- `docs/tasks/concluidos/10-conversor-dfm-para-lfm.md` (critério dos blobs)
- `docs/tasks/concluidos/12-comparacao-visual.md` (tabela de achados + critério herdado)
