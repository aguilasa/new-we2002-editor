...
([CORR-WTE-139](/docs/tasks/concluidos/CORR-WTE-139.md)), porque ali o `.rc` declara um
...
2. `docs/PLAN-LINUX.md` — entrada na lista de divergências deliberadas, ao lado
   da [CORR-WTE-140](/docs/tasks/concluidos/CORR-WTE-140.md).
...
- `docs/tasks/concluidos/CORR-WTE-141.md` — modificado (causa raiz corrigida, verificação, log)
- `CLAUDE.md` — modificado (o parágrafo do `autoDefault=false` ganha a decisão,
  para ninguém "consertar" a ausência do `Return`)
- `docs/tasks/concluidos/correcoes-progresso.md` — modificado (tabela e checklist)
