...
- Executar o transpilador da WTE-TASK-17 sobre as 2.504 linhas (medidas — ver o
  ...
  desde a [CORR-WTE-034](/docs/tasks/concluidos/CORR-WTE-034.md)) e resolver o que
  o `FORBIDDEN` recusar.
...
- **Problemas encontrados:**
  ...
  escopo desta task lista **seis** desde a [CORR-WTE-034](/docs/tasks/concluidos/CORR-WTE-034.md),
