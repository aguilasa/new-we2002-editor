...
- [ ] ~~Decrementa junto com o original após inserção~~ — **não medido, e o
      ...
      [WTE-TASK-27](/docs/tasks/concluidos/27-handlers-de-gravacao.md) declarou lacuna
...
o fez procurar no lugar certo. A [WTE-TASK-27](/docs/tasks/concluidos/27-handlers-de-gravacao.md)
...
- **Problemas encontrados:**
  ...
  - **`b0 >= 120` não é modelado, e ficou escrito assim.** Ali o original soma
    ...
    ([CORR-WTE-065](/docs/tasks/concluidos/CORR-WTE-065.md)).
