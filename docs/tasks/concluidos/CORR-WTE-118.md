...
A [WTE-TASK-39](/docs/tasks/concluidos/39-empacotamento.md) recebeu da
[WTE-TASK-38](/docs/tasks/concluidos/38-nome-e-linhagem.md) um repasse com inventário
...
[WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md) batizou: documento que
envelhece sozinho enquanto alguém o lê como estado corrente. Aqui o prazo é
curto — a próxima leitora é a
[WTE-TASK-40](/docs/tasks/concluidos/40-verificacao-final.md), que confere o produto
instalado.
...
### Arquivo: `docs/tasks/concluidos/39-empacotamento.md`
...
- [x] `grep -n "passam a levar o slug" docs/tasks/concluidos/39-empacotamento.md` sai
