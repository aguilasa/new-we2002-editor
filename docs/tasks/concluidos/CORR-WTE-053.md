...
[WTE-TASK-22](/docs/tasks/concluidos/22-harness-golden.md) é a medida que define o que o
...
[WTE-TASK-25](/docs/tasks/concluidos/25-handlers-de-carga.md), em execução enquanto isto
...
| Arquivo | Ação |
|---|---|
| `docs/tasks/concluidos/22-harness-golden.md` | modificado — seção 2 reescrita |
