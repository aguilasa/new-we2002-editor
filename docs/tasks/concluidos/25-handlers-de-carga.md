...
[WTE-TASK-29](/docs/tasks/concluidos/29-camisa-e-bandeira-2d.md). Mas a 29 dependia da 27,
...
[WTE-TASK-22](/docs/tasks/concluidos/22-harness-golden.md), e ela se desfez por decisão,
...
- o `check_fase2.py` conta as linhas do `.aux.inc` como escritas à mão, junto
  ...
  auxiliar escrito, que é a [CORR-WTE-051](/docs/tasks/concluidos/CORR-WTE-051.md) pela
  terceira vez.
...
[WTE-TASK-12](/docs/tasks/concluidos/12-comparacao-visual.md) não conseguiria abrir
formulário para capturar
([WTE-TASK-11](/docs/tasks/concluidos/11-app-com-a-casca-completa.md), problema 3). Quando
...
- [x] Tela conferida contra o original para pelo menos 3 times distintos, nos
      ...
      nomeada da [WTE-TASK-29](/docs/tasks/concluidos/29-camisa-e-bandeira-2d.md).
      Times 2, 9 e 63 (clube de ML), ROM japonesa, por
      `wte/tools/compara_tela.sh`: as 15 larguras de barra batem em pixel.
      **Os cinco grupos, desde a [CORR-WTE-057](/docs/tasks/concluidos/CORR-WTE-057.md):**
...
- **Resumo do que foi feito:**
  ...
  **A fração da §4.4 estava sendo medida com uma população só.** O mecanismo de
  ...
  cada corpo escrito. É o erro da [CORR-WTE-051](/docs/tasks/concluidos/CORR-WTE-051.md)
...
- **Por que o Pascal não foi escrito:**
  ...
  [WTE-TASK-29](/docs/tasks/concluidos/29-camisa-e-bandeira-2d.md)), e `0x0040b0b4` /
...
- **Resumo do que foi feito:**
  ...
  **Os dois oráculos se encontraram mais duas vezes, e as duas viraram guarda
  ...
  [WTE-TASK-06](/docs/tasks/concluidos/06-mapa-de-offsets.md) a registrou — duas medições
  ...
  **E o "decodificador de nome" não decodifica.** `0x0040b2d8` indexa duas
  ...
  a [WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md). A conferência
...
- **Por que o Pascal continua não escrito:**
  ...
  [WTE-TASK-26](/docs/tasks/concluidos/26-handlers-de-edicao.md) traz mais auxiliares
...
- **Depois da passagem, duas decisões do usuário** *(2026-08-11)***:**
  ...
  [WTE-TASK-29](/docs/tasks/concluidos/29-camisa-e-bandeira-2d.md) — exclusão sem dono
  nomeado é buraco.
...
- **Resumo do que foi feito:**
  ...
  [WTE-TASK-06](/docs/tasks/concluidos/06-mapa-de-offsets.md)), e o mesmo elenco para nome
...
- **O que fica para outras tasks, com dono escrito:**
  - encher a ficha de jogador e a tela de tática (`0x00404820`, `0x0040756c`,
    `0x0040a0b4`) — [WTE-TASK-26](/docs/tasks/concluidos/26-handlers-de-edicao.md);
  - `ficha_color.FormCreate` e `estrategia.FormCreate` — 26/32;
  - bandeira e uniforme 2D — [WTE-TASK-29](/docs/tasks/concluidos/29-camisa-e-bandeira-2d.md),
    que herdou a linha de critério de tela;
  - o `.mcr` — [WTE-TASK-28](/docs/tasks/concluidos/28-import-de-mcr.md);
  - o desenho do combo de tática — [WTE-TASK-37](/docs/tasks/concluidos/37-reconferencia-de-ui.md).
...
- **O que fica em aberto sem dono, e é dívida registrada:**
  ...
  - ~~as duas faixas de arranque sem causa (`1921862`, `2012984..2012985`), que
    são do gate da [WTE-TASK-22](/docs/tasks/concluidos/22-harness-golden.md)~~ —
    **fechado em 2026-08-20** pela oitava passagem da
    [WTE-TASK-27](/docs/tasks/concluidos/27-handlers-de-gravacao.md). São dois remendos
...
de ML**, e por isso a [WTE-TASK-19](/docs/tasks/concluidos/19-os-50-offsets-restantes.md)
...
[CORR-WTE-081](/docs/tasks/concluidos/CORR-WTE-081.md) já ajustou.
