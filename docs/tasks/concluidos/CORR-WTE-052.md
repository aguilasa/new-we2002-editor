...
O Log de Execução da [WTE-TASK-22](/docs/tasks/concluidos/22-harness-golden.md) afirma, em
...
[CORR-WTE-038](/docs/tasks/concluidos/CORR-WTE-038.md) trocou 41 por 47 e a
[CORR-WTE-042](/docs/tasks/concluidos/CORR-WTE-042.md) trocou 33 por 38, as duas em número
...
- [ ] `grep -n "15 testes" docs/tasks/concluidos/22-harness-golden.md` não devolve nada
...
[WTE-TASK-19](/docs/tasks/concluidos/19-os-50-offsets-restantes.md), e é de outro arquivo
...
| Arquivo | Ação |
|---|---|
| `docs/tasks/concluidos/22-harness-golden.md` | modificado — 18 nos dois sítios, com o comando |
| `docs/tasks/concluidos/CORR-WTE-052.md` | `status: concluído` e este Log |
