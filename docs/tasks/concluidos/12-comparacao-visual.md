...
2. O app Lazarus no `:99`. **Ele não navega** — na fase 2 os handlers são stub
   ([WTE-TASK-11](/docs/tasks/concluidos/11-app-com-a-casca-completa.md), problema 3). O
...
[WTE-TASK-37](/docs/tasks/concluidos/37-reconferencia-de-ui.md), **se** o crash se
resolver; o crash em si é bloqueio da
[WTE-TASK-22](/docs/tasks/concluidos/22-harness-golden.md), onde está registrado.
...
- [x] Os 118 blobs aparecem na janela — critério herdado da
      [WTE-TASK-10](/docs/tasks/concluidos/10-conversor-dfm-para-lfm.md), que provou a
...
- [x] O sufixo ` [Lazarus]` no `Caption` **não** foi contado como achado — é
      ...
      [WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md). No `:99` não há
...
- **Arquivos criados/modificados:**
  ...
  | `docs/tasks/concluidos/22-harness-golden.md` | modificar — os três hand-offs e o critério |
  | `docs/tasks/concluidos/12-comparacao-visual.md` | modificar — resultado e Log |
