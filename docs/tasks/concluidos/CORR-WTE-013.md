...
[CORR-WTE-008](/docs/tasks/concluidos/CORR-WTE-008.md) fixou esse decodificador em teste
...
- `docs/tasks/concluidos/07-unidades-duvidosas.md` — o Log aponta para esta correção
