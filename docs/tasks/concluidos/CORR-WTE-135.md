...
A [PAR-TASK-06](/docs/tasks/concluidos/PAR-TASK-06.md) diz, na própria seção **Método**,
...
| `docs/tasks/concluidos/PAR-TASK-06.md` | modificar — o item 5 e o Log |
...
Isto **confirma em bytes** o que a [CORR-WTE-132](/docs/tasks/concluidos/CORR-WTE-132.md)
...
2. **O `QPushButton` clicado fica com o foco e come o `Return`.** No Qt um
   ...
   [CORR-WTE-139](/docs/tasks/concluidos/CORR-WTE-139.md)** — aqui foi contornada para
...
| `docs/tasks/concluidos/PAR-TASK-06.md` | o item 5 e o parágrafo sobre o valor da troca nos dois sentidos |
