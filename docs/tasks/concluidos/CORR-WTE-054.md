...
| `docs/tasks/concluidos/24-ghidra-convencao-borland.md` | modificado — o `~150` do Log virou 108 medido |
| `docs/tasks/concluidos/CORR-WTE-054.md` | `status: concluído` e este Log |
