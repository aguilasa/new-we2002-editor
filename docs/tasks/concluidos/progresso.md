...
[CORR-WTE-044](/docs/tasks/concluidos/CORR-WTE-044.md) desfez isso; a 4ª passagem cobriu as
...
- [x] **Três `aberto` estavam presos por "nada exercita o corpo" e a bateria
      ...
      [CORR-WTE-089](/docs/tasks/concluidos/CORR-WTE-089.md), 2026-08-24)*. A frase tinha
...
- [x] **Três `aberto` esperavam decisão, não medição, e um deles fechava um
      ...
      pela [CORR-WTE-063](/docs/tasks/concluidos/CORR-WTE-063.md); o
      ...
      esperava a [WTE-TASK-37](/docs/tasks/concluidos/37-reconferencia-de-ui.md), **que é
...
- [x] **Três gravações órfãs, achado da WTE-TASK-30 (2026-08-21), fechadas
      pela [CORR-WTE-081](/docs/tasks/concluidos/CORR-WTE-081.md).** O grupo `auxiliar` não era
      ...
      [WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md)**, que é fechamento e
      ...
      **Duas das três fecharam em 2026-08-21.** O `Comple.` do `jugador`
      ...
      [CORR-WTE-082](/docs/tasks/concluidos/CORR-WTE-082.md) portou a `0x0040A0B4` como
...
- [x] **Dez times desenham bandeira preta** *(achado da WTE-TASK-31,
      ...
      [CORR-WTE-083](/docs/tasks/concluidos/CORR-WTE-083.md) em 2026-08-23)*. O
      ...
      **Consertado no mesmo dia pela rota B**, com a
      ...
      [CORR-WTE-084](/docs/tasks/concluidos/CORR-WTE-084.md) mediu em 2026-08-23 que o
...
- [x] Slots de ML batendo com a tela do original nas duas ROMs — europeia `13` nos dois lados; japonesa `1` nos dois com o mesmo conteúdo de arquivo (o oráculo altera a imagem ao abrir, ver a [WTE-TASK-33](/docs/tasks/concluidos/33-slots-de-master-league.md))
...
- [x] Edição múltipla e gravação dupla cobertas — os dois roteiros novos da
      ...
      em 2026-08-25**, pela
      [CORR-WTE-104](/docs/tasks/concluidos/CORR-WTE-104.md): o roteiro gravava num time
...
- [x] **A §8.9 reabriu, e quatro vezes maior** *(achado da WTE-TASK-37)*. Ela
      ...
      *default* de widgetset sobre propriedade que o DFM não declara:
      ...
      encaminhada ao gerador ([WTE-TASK-10](/docs/tasks/concluidos/10-conversor-dfm-para-lfm.md))
...
- **~~O `wte.exe` não passa da tela de carga~~ — resolvido em 2026-08-10, com a
  ...
  **49.749 violações de acesso com `roms/golden-european-deluxe.bin`, 0 com
  ...
  [WTE-TASK-22](/docs/tasks/concluidos/22-harness-golden.md) **tem em que se apoiar**,
...
[WTE-TASK-25](/docs/tasks/concluidos/25-handlers-de-carga.md), **depois** do gate da
[22](/docs/tasks/concluidos/22-harness-golden.md): fazê-la no fechamento seria implementar
...
[CORR-WTE-018](/docs/tasks/concluidos/CORR-WTE-018.md): a exclusão que ele tinha valia
...
[CORR-WTE-051](/docs/tasks/concluidos/CORR-WTE-051.md) de novo, e das duas vezes quem
...
onde a [WTE-TASK-06](/docs/tasks/concluidos/06-mapa-de-offsets.md) a registrou por outro
...
[WTE-TASK-27](/docs/tasks/concluidos/27-handlers-de-gravacao.md), que `depends_on` a 26 —
a mesma forma de circularidade que a
[CORR-WTE-044](/docs/tasks/concluidos/CORR-WTE-044.md) desfez para o gate e que a decisão
...
A [CORR-WTE-121](/docs/tasks/concluidos/CORR-WTE-121.md) é a razão de a ordem começar por
...
medidos; os outros dois encaminhados para a seção "Bônus que só o Windows
consegue" do [/docs/PLAN-WINDOWS.md](/docs/PLAN-WINDOWS.md)), a 10 pela Citrix
filtrar input sintético no Windows, e a 11 por decisão de manter o SoFIFA
...
[CORR-WTE-123](/docs/tasks/concluidos/CORR-WTE-123.md) teve de reconstruir depois da 01.
