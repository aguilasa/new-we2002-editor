...
- [x] Abrir o combo, **navegar com as setas sem sair do controle**, apertar
      ...
      aqui, e foi fechado pela [CORR-WTE-125](/docs/tasks/concluidos/CORR-WTE-125.md);
...
- [x] Divergência fora de `405724..405739` registrada como CORR, com a faixa e o
      offset simbólico — foi a [CORR-WTE-125](/docs/tasks/concluidos/CORR-WTE-125.md)
- [x] `roms/` intocada

## Log de Execução

**Executado em:** 2026-08-28 — parcial, 2 de 3 itens. **Fechada em
2026-08-29**, quando a [CORR-WTE-125](/docs/tasks/concluidos/CORR-WTE-125.md) corrigiu o
item 1.
...
- `docs/tasks/concluidos/CORR-WTE-125.md` — o achado
- `docs/tasks/concluidos/correcoes-progresso.md` — a linha e o checklist

**Adendo da [CORR-WTE-125](/docs/tasks/concluidos/CORR-WTE-125.md), 2026-08-29.** O item 1
...
- `docs/tasks/concluidos/PAR-TASK-03.md` — este Log
