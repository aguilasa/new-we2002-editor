...
A [PAR-TASK-02](/docs/tasks/concluidos/PAR-TASK-02.md) fecha com este item marcado:
...
**O item 3 cumpre** — a [CORR-WTE-124](/docs/tasks/concluidos/CORR-WTE-124.md) criou o
...
Isto é a [CORR-WTE-123](/docs/tasks/concluidos/CORR-WTE-123.md) de novo, e desta vez
...
### Arquivo: `docs/tasks/concluidos/PAR-TASK-02.md`
...
| `docs/tasks/concluidos/PAR-TASK-02.md` | modificar |
...
- `docs/PARIDADE-FUNCIONAL.md` — §8.2: o roteiro e a faixa remedida em cada um
  ...
  um roteiro por item
- `docs/tasks/concluidos/PAR-TASK-02.md` — os dois itens apontando para o seu roteiro e o
  adendo no Log
