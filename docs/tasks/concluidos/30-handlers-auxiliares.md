...
[WTE-TASK-32](/docs/tasks/concluidos/32-preco-do-jogador.md) — *"são fórmula, não
...
[CORR-WTE-086](/docs/tasks/concluidos/CORR-WTE-086.md):
...
- **Arquivos criados/modificados:**
  ...
  - `docs/tasks/concluidos/32-preco-do-jogador.md` — o `base_teamClick` acrescentado ao
...
- **Problemas encontrados:**
  ...
  **Três rotas de gravação sem dono.** É o único item aberto que esta task não
  ...
  usuário:** virou a [CORR-WTE-081](/docs/tasks/concluidos/CORR-WTE-081.md), que as
