...
A [WTE-TASK-30](/docs/tasks/concluidos/30-handlers-auxiliares.md) mediu os 17 handlers do
...
[WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md) é o fechamento da fase e o
...
- [x] `estrategia.BitBtn3Click`: a `0x0040A0B4` portada antes pela
      [CORR-WTE-082](/docs/tasks/concluidos/CORR-WTE-082.md), e a tela conferida contra o
...
[CORR-WTE-082](/docs/tasks/concluidos/CORR-WTE-082.md) antes.
...
- **`estrategia.BitBtn3Click`** — o pré-requisito que esta correção declarou
  ...
  [CORR-WTE-082](/docs/tasks/concluidos/CORR-WTE-082.md), e o `depends_on` do frontmatter
...
- reconciliação de doc, em commit próprio:
  `wte/tests/roteiros/README.md`, `docs/tasks/concluidos/progresso.md`
...
- reconciliação de doc, em commit próprio: `wte/tools/dump_auxiliares.py` e
  ...
  `docs/tasks/concluidos/progresso.md`
...
- reconciliação de doc, em commit próprio: `wte/tools/dump_zonas.py` e
  `wte/re/zonas.md`, `docs/tasks/concluidos/progresso.md`
