...
### Arquivo: `docs/PARIDADE-FUNCIONAL.md` e `docs/tasks/concluidos/PAR-TASK-07.md`
...
| `docs/tasks/concluidos/PAR-TASK-07.md` | modificar — o Log do item 3 |
...
| `docs/tasks/concluidos/PAR-TASK-07.md` | nota posterior no Log, com os quatro mecanismos |
