...
[CORR-WTE-135](/docs/tasks/concluidos/CORR-WTE-135.md)).
...
cujo veredito é o que a [CORR-WTE-135](/docs/tasks/concluidos/CORR-WTE-135.md) vai
produzir.
...
[134](/docs/tasks/concluidos/CORR-WTE-134.md) acrescentou o `8.7-escape-papel-preset.sh` ao
glob e a [135](/docs/tasks/concluidos/CORR-WTE-135.md) deu veredito aos dois do `.t2002`.
...
| `docs/tasks/concluidos/PAR-TASK-06.md` | o ordinal, a ressalva de que os seis re-rodados não são todos, e as cinco CORRs |
