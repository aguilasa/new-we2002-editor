...
| `docs/tasks/concluidos/33-slots-de-master-league.md` | 179 | `Nenhuma das duas ROMs chega lá — o maior `b0` medido é 43 —` |
...
### Arquivo: `docs/tasks/concluidos/33-slots-de-master-league.md`
...
| `docs/tasks/concluidos/33-slots-de-master-league.md` | modificar |
...
- `docs/tasks/concluidos/33-slots-de-master-league.md`
