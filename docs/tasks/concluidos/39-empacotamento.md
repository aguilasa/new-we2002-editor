...
- **Arquivos criados/modificados:** conferido contra `git show --stat`.
  ...
  `docs/tasks/concluidos/progresso.md`, este arquivo, e o repasse em
  [`docs/tasks/concluidos/40-verificacao-final.md`](/docs/tasks/concluidos/40-verificacao-final.md).
...
> [CORR-WTE-118](/docs/tasks/concluidos/CORR-WTE-118.md) em 2026-08-26 — a instrução
...
[CORR-WTE-116](/docs/tasks/concluidos/CORR-WTE-116.md): esta receita punha o `re/` irmão
do **arquivo**, e assim o diálogo continua.)*

Duas consequências para esta task:

1. **A condição 3 da [WTE-TASK-40](/docs/tasks/concluidos/40-verificacao-final.md) —
