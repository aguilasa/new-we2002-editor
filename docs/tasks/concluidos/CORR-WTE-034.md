...
| `docs/tasks/concluidos/15-mapeamento-de-tipo.md` | modificar (varredura) |
| `docs/tasks/concluidos/17-transpilador-da-camada-de-dados.md` | modificar (varredura) |
| `docs/tasks/concluidos/18-camada-de-dados-gerada.md` | modificar (varredura) |
