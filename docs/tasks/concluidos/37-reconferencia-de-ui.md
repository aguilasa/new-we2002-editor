...
- [x] Achado que volta para outra fase registrado com a task de destino —
      linhas escritas nas tasks [10](/docs/tasks/concluidos/10-conversor-dfm-para-lfm.md),
      [19](/docs/tasks/concluidos/19-os-50-offsets-restantes.md),
      [25](/docs/tasks/concluidos/25-handlers-de-carga.md) e
      [35](/docs/tasks/concluidos/35-divergencias-deliberadas.md), e a decisão do
...
- **Arquivos criados/modificados:** conferido contra `git show --stat`.
  ...
  disco), `docs/PLAN-WTE-LAZARUS.md`, `docs/tasks/concluidos/progresso.md`, este arquivo, e
  **os quatro repasses**: `docs/tasks/concluidos/10-conversor-dfm-para-lfm.md`,
...
- **Problemas encontrados:**
  ...
  **1. O `--roteiro` do `golden_suite.sh` TRUNCA o TSV.** Rodar
  ...
  > [CORR-WTE-113](/docs/tasks/concluidos/CORR-WTE-113.md)** — o item que este parágrafo
