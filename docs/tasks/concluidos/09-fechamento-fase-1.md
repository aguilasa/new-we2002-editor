...
- **Arquivos criados/modificados:**
  ...
  | `docs/tasks/concluidos/progresso.md` | modificado — marcação, tabela de estado, censo, três seções de prosa, estrutura de pastas, nota de execução |
  | `docs/tasks/concluidos/08-convencao-dos-assets.md` | modificado — o título dizia 197 |
  | `docs/tasks/concluidos/38-nome-e-linhagem.md`, `39-empacotamento.md` | modificados — pendentes, iam pedir mensagem de erro e regra de empacotamento sobre 197 |
