...
A [WTE-TASK-32](/docs/tasks/concluidos/32-preco-do-jogador.md) abre com:
...
| Arquivo | Ação |
|---|---|
| `docs/tasks/concluidos/32-preco-do-jogador.md` | modificar (a premissa e a nota de oráculo B) |
| `docs/tasks/concluidos/correcoes-progresso.md` | modificar |
