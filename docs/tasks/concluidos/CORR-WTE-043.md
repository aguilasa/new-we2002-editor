...
[WTE-TASK-20](/docs/tasks/concluidos/20-round-trip-headless.md) **não pega isto** — ele
...
`docs/tasks/concluidos/18-camada-de-dados-gerada.md:164`, que está **dentro do Log de
Execução** (linha 113) — história de tarefa executada, deixada como está, pelo
mesmo critério da [CORR-WTE-040](/docs/tasks/concluidos/CORR-WTE-040.md).

A linha nova de `recusas.md` levava link `/docs/...`; corrigida para
`../../docs/...`, que é o que a [CORR-WTE-027](/docs/tasks/concluidos/CORR-WTE-027.md)
