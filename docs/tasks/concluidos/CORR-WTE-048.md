...
a [CORR-WTE-044](/docs/tasks/concluidos/CORR-WTE-044.md) mediu **0 violação de acesso** com
`roms/japanese-shift-jis.bin` contra 49.749 com a europeia, e a
[WTE-TASK-19](/docs/tasks/concluidos/19-os-50-offsets-restantes.md) fechou dirigindo o
...
[WTE-TASK-22](/docs/tasks/concluidos/22-harness-golden.md), cujo gate depende exatamente de
...
- [x] `grep -rn "tela de carga" wte/ docs/` só devolve documento que **narra** a
      ...
      `docs/tasks/concluidos/progresso.md:346` (riscado, com a data da resolução) e os
      `CORR-*`
...
Isso importa para a [WTE-TASK-22](/docs/tasks/concluidos/22-harness-golden.md): o gate
