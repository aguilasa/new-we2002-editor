...
irmão: o Log da [CORR-WTE-007](/docs/tasks/concluidos/CORR-WTE-007.md) registra
...
1. **O `grep` da CORR parava em `wte/re/*.md`**, sem descer para `wte/re/spec/`
   ...
   [CORR-WTE-016](/docs/tasks/concluidos/CORR-WTE-016.md) já corrigiu no `check_fase1.py`:
...
De quebra, uma linha longa que a [CORR-WTE-030](/docs/tasks/concluidos/CORR-WTE-030.md)
