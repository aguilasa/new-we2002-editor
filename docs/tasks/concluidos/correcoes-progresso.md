...
| --- | --- | --- | --- | --- | --- |
| [CORR-WTE-001](/docs/tasks/concluidos/CORR-WTE-001.md) | Correção: frontmatter da task diz `pendente` numa tarefa concluída | WTE-TASK-01 | low | done | 2026-08-05 |
| [CORR-WTE-002](/docs/tasks/concluidos/CORR-WTE-002.md) | Correção: dois números do `ambiente.md` só são reproduzíveis pelo scratchpad | WTE-TASK-01 | low | done | 2026-08-05 |
| [CORR-WTE-003](/docs/tasks/concluidos/CORR-WTE-003.md) | Correção: a seção `wte/` do `.gitignore` ignora `lib/` e `backup/` no repositório inteiro | WTE-TASK-02 | low | done | 2026-08-05 |
| [CORR-WTE-004](/docs/tasks/concluidos/CORR-WTE-004.md) | Correção: `--check` fica vermelho num clone limpo, porque `blobs/` é gitignored e o modo de conferência nunca o materializa | WTE-TASK-03 | low | done | 2026-08-05 |
| [CORR-WTE-005](/docs/tasks/concluidos/CORR-WTE-005.md) | Correção: os streams sintéticos que sustentam "os 21 TValueType exercitados" não são versionados | WTE-TASK-03 | low | done | 2026-08-06 |
| [CORR-WTE-006](/docs/tasks/concluidos/CORR-WTE-006.md) | Correção: os fatos medidos pela WTE-TASK-04 não chegaram aos documentos que serão executados | WTE-TASK-04 | high | done | 2026-08-06 |
| [CORR-WTE-007](/docs/tasks/concluidos/CORR-WTE-007.md) | Correção: a tabela "onde o plano envelheceu" atribui ao plano uma frase que só existe na task, e não registra três divergências medidas | WTE-TASK-04 | low | done | 2026-08-06 |
| [CORR-WTE-008](/docs/tasks/concluidos/CORR-WTE-008.md) | Correção: o decodificador de instrução x86 do dump_strings.py só foi conferido à mão, e a coluna `handler` inteira depende dele | WTE-TASK-05 | low | done | 2026-08-06 |
| [CORR-WTE-009](/docs/tasks/concluidos/CORR-WTE-009.md) | Correção: a §8.8 e a pendência do progresso.md ainda tratam o binário espanhol como única rota para as mensagens decepadas | WTE-TASK-05 | low | done | 2026-08-06 |
| [CORR-WTE-010](/docs/tasks/concluidos/CORR-WTE-010.md) | Correção: a §8.7 do plano e o enunciado da WTE-TASK-06 apontam o lado errado, e o ASCII citado não é o do binário | WTE-TASK-06 | high | done | 2026-08-06 |
| [CORR-WTE-011](/docs/tasks/concluidos/CORR-WTE-011.md) | Correção: o critério de limite do dump_offsets.py aborta num sentido só, e a janela de plausibilidade sai do nosso próprio header | WTE-TASK-06 | low | done | 2026-08-06 |
| [CORR-WTE-012](/docs/tasks/concluidos/CORR-WTE-012.md) | Correção: a §1 do plano diz 300 imports de rtl60/vcl60 (são 267) e chama o TBrowseURL de componente de terceiro, que a §5 do mesmo arquivo já desmente | WTE-TASK-07 | high | done | 2026-08-06 |
| [CORR-WTE-013](/docs/tasks/concluidos/CORR-WTE-013.md) | Correção: o decodificador x86 do dump_units.py é cópia verbatim do dump_strings.py e nenhum teste o alcança | WTE-TASK-07 | low | done | 2026-08-06 |
| [CORR-WTE-014](/docs/tasks/concluidos/CORR-WTE-014.md) | Correção: o 197 bitmaps ficou sem dono — não está no quadro de reconciliação da WTE-TASK-09 e sobrevive em nove lugares | WTE-TASK-08 | high | done | 2026-08-06 |
| [CORR-WTE-015](/docs/tasks/concluidos/CORR-WTE-015.md) | Correção: duas transcrições de evidência do assets.md não batem com a medida — o ano dos 195 .bmp e o endereço do fread | WTE-TASK-08 | low | done | 2026-08-06 |
| [CORR-WTE-016](/docs/tasks/concluidos/CORR-WTE-016.md) | Correção: a varredura de sítios para em `docs/` e `wte/re/`, e o `wte/README.md` continua afirmando que a §1 do plano registra 197 bitmaps | WTE-TASK-09 | low | done | 2026-08-06 |
| [CORR-WTE-017](/docs/tasks/concluidos/CORR-WTE-017.md) | Correção: o `fase-1.md` separa offset em tabela de offset em `.text` por substring do endereço, e a igualdade que a prosa afirma não é conferida | WTE-TASK-09 | low | done | 2026-08-06 |
| [CORR-WTE-018](/docs/tasks/concluidos/CORR-WTE-018.md) | Correção: o `02-revisar.md` cita ~430, 70 e 197 como “o que já está no plano”, e o plano não diz mais isso | WTE-TASK-09 | low | done | 2026-08-09 |
| [CORR-WTE-019](/docs/tasks/concluidos/CORR-WTE-019.md) | Correção: a reversão que versionou 816.880 bytes de arte do Obocaman só está registrada num README derivado | WTE-TASK-10 | high | done | 2026-08-09 |
| [CORR-WTE-020](/docs/tasks/concluidos/CORR-WTE-020.md) | Correção: a tabela de propriedades do dfm2lfm.py diz ter sido medida na LCL 3.0, e nada remede — LCL_VERSAO é código morto | WTE-TASK-10 | high | done | 2026-08-09 |
| [CORR-WTE-021](/docs/tasks/concluidos/CORR-WTE-021.md) | Correção: o critério "blobs visíveis na janela" foi adiado para a WTE-TASK-11, que não o tem | WTE-TASK-10 | low | done | 2026-08-09 |
| [CORR-WTE-022](/docs/tasks/concluidos/CORR-WTE-022.md) | Correção: o comando publicado da ordem de auto-create devolve 17 das 18 classes, e a que ele perde é TMainForm | WTE-TASK-11 | high | done | 2026-08-09 |
| [CORR-WTE-023](/docs/tasks/concluidos/CORR-WTE-023.md) | Correção: o critério de build da WTE-TASK-11 diz 2.482 linhas e atribui os 2 hints ao Lazarus; são 2.562 e vêm do /etc/fpc.cfg | WTE-TASK-11 | high | done | 2026-08-09 |
| [CORR-WTE-024](/docs/tasks/concluidos/CORR-WTE-024.md) | Correção: as duas coisas que a WTE-TASK-11 delegou — o sufixo [Lazarus] e o --show — não chegaram a quem recebe | WTE-TASK-11 | low | done | 2026-08-09 |
| [CORR-WTE-025](/docs/tasks/concluidos/CORR-WTE-025.md) | Correção: a faixa `11797..26528` é numeração 1-based do `cmp`, e vai virar exceção declarada como se fosse offset | WTE-TASK-12 | high | done | 2026-08-09 |
| [CORR-WTE-026](/docs/tasks/concluidos/CORR-WTE-026.md) | Correção: a coluna VCL da tabela do achado 2 não foi medida, e a tabela se anuncia inteira como medida | WTE-TASK-13 | low | done | 2026-08-10 |
| [CORR-WTE-027](/docs/tasks/concluidos/CORR-WTE-027.md) | Correção: o `fase-2.md` emite link `/docs/...` de dentro de `wte/re/`, fora do perímetro da regra | WTE-TASK-14 | low | done | 2026-08-10 |
| [CORR-WTE-028](/docs/tasks/concluidos/CORR-WTE-028.md) | Correção: `conferir_vereditos()` guarda a coluna `Original`, não o veredito | WTE-TASK-14 | low | done | 2026-08-10 |
| [CORR-WTE-029](/docs/tasks/concluidos/CORR-WTE-029.md) | Correção: o Log da WTE-TASK-16 diz que a reconciliação do `fase-2.md` saiu em commit próprio, e ela saiu no mesmo commit | WTE-TASK-16 | low | done | 2026-08-10 |
| [CORR-WTE-030](/docs/tasks/concluidos/CORR-WTE-030.md) | Correção: o `tipos.md` conta 38 `strcpy`, e o `Database.cpp` tem 40 — os dois que faltam são `std::strcpy` | WTE-TASK-15 | high | done | 2026-08-10 |
| [CORR-WTE-031](/docs/tasks/concluidos/CORR-WTE-031.md) | Correção: o `wte/tests/README.md` diz que a pasta está vazia e é só Pascal, e a WTE-TASK-16 pôs dois arquivos lá, um deles C++ | WTE-TASK-16 | low | done | 2026-08-10 |
| [CORR-WTE-032](/docs/tasks/concluidos/CORR-WTE-032.md) | Correção: a "regra zero" do `tipos.md` proíbe `LongInt` e `SizeInt` em campo de registro, e a tabela usa os dois | WTE-TASK-15 | high | done | 2026-08-10 |
| [CORR-WTE-034](/docs/tasks/concluidos/CORR-WTE-034.md) | Correção: a "entrada real medida" do `tipos.md` omite os cabeçalhos que declaram os campos que a tabela mapeia | WTE-TASK-15 | high | done | 2026-08-10 |
| [CORR-WTE-035](/docs/tasks/concluidos/CORR-WTE-035.md) | Correção: a decisão 5 do `tipos.md` não tem o "teste que prova", e o critério que o exige está marcado | WTE-TASK-15 | low | done | 2026-08-10 |
| [CORR-WTE-036](/docs/tasks/concluidos/CORR-WTE-036.md) | Correção: a regra `!` → `not` do `SUBS` atravessa a quebra de linha e engole seis statements para dentro de comentário | WTE-TASK-17 | high | done | 2026-08-10 |
| [CORR-WTE-037](/docs/tasks/concluidos/CORR-WTE-037.md) | Correção: a linha das recusas medidas na saída está deslocada, e o worklist da WTE-TASK-18 aponta para a linha errada | WTE-TASK-17 | high | stale | 2026-08-10 |
| [CORR-WTE-038](/docs/tasks/concluidos/CORR-WTE-038.md) | Correção: o Log da WTE-TASK-17 diz 41 regras de substituição, e o gerador tem 47 | WTE-TASK-17 | high | done | 2026-08-10 |
| [CORR-WTE-039](/docs/tasks/concluidos/CORR-WTE-039.md) | Correção: o GABARITO diz que o gerador recusa `(int)*(int *)`, e ele aceita | WTE-TASK-23 | high | done | 2026-08-10 |
| [CORR-WTE-040](/docs/tasks/concluidos/CORR-WTE-040.md) | Correção: o GABARITO diz quatro famílias de `BitBtnNClick`, e são três | WTE-TASK-23 | high | done | 2026-08-10 |
| [CORR-WTE-041](/docs/tasks/concluidos/CORR-WTE-041.md) | Correção: o `spec_index.py` tem 15 rotas de recusa, e o README chama as onze testadas de "as" rotas | WTE-TASK-23 | low | done | 2026-08-10 |
| [CORR-WTE-042](/docs/tasks/concluidos/CORR-WTE-042.md) | Correção: o Log da WTE-TASK-18 diz que os testes do transpilador eram 33, e eram 38 | WTE-TASK-18 | high | done | 2026-08-10 |
| [CORR-WTE-043](/docs/tasks/concluidos/CORR-WTE-043.md) | Correção: `players[i].cost := Ord(buf1[0])` perde o sinal que o C++ tem | WTE-TASK-18 | low | done | 2026-08-10 |
| [CORR-WTE-044](/docs/tasks/concluidos/CORR-WTE-044.md) | Correção: o oráculo comportamental está morto e a fase 4 é circular | WTE-TASK-19 | high | done | 2026-08-10 |
| [CORR-WTE-045](/docs/tasks/concluidos/CORR-WTE-045.md) | Correção: a seção das seis áreas cita `roms/09-areas-com-time`, que é o nome da sessão e não o da imagem | WTE-TASK-19 | low | done | 2026-08-10 |
| [CORR-WTE-046](/docs/tasks/concluidos/CORR-WTE-046.md) | Correção: três vereditos citam `case N` onde o `Database.cpp` tem `if(i == N)` | WTE-TASK-19 | low | done | 2026-08-10 |
| [CORR-WTE-047](/docs/tasks/concluidos/CORR-WTE-047.md) | Correção: a segunda régua (`cmp`) das sessões 10 e 11 não ficou registrada em lugar nenhum | WTE-TASK-19 | low | done | 2026-08-10 |
| [CORR-WTE-048](/docs/tasks/concluidos/CORR-WTE-048.md) | Correção: o `fase-3.md` ainda diz que o `wte.exe` não passa da tela de carga | WTE-TASK-20 | low | done | 2026-08-10 |
| [CORR-WTE-049](/docs/tasks/concluidos/CORR-WTE-049.md) | Correção: o parágrafo de dependência da WTE-TASK-20 troca as duas populações de offset, e cita a 19 como bloqueada | WTE-TASK-20 | low | done | 2026-08-10 |
| [CORR-WTE-050](/docs/tasks/concluidos/CORR-WTE-050.md) | Correção: a razão entrada × saída divide 3.692 linhas de Pascal por uma entrada que só explica 2.984 delas | WTE-TASK-21 | high | done | 2026-08-10 |
| [CORR-WTE-051](/docs/tasks/concluidos/CORR-WTE-051.md) | Correção: a fração de 92,5% subtrai linhas úteis de um total que conta linhas em branco | WTE-TASK-21 | low | done | 2026-08-10 |
| [CORR-WTE-052](/docs/tasks/concluidos/CORR-WTE-052.md) | Correção: o Log da WTE-TASK-22 diz 15 testes no `golden_veredito`, e são 18 | WTE-TASK-22 | high | done | 2026-08-11 |
| [CORR-WTE-053](/docs/tasks/concluidos/CORR-WTE-053.md) | Correção: a seção 2 da WTE-TASK-22 descreve o controle como uma faixa só, e o gate declara nove | WTE-TASK-22 | low | done | 2026-08-11 |
| [CORR-WTE-054](/docs/tasks/concluidos/CORR-WTE-054.md) | Correção: o `vmt.md` diz que todo número saiu do `vmt_probe.java`, e os votos da âncora não saíram | WTE-TASK-24 | high | done | 2026-08-11 |
| [CORR-WTE-055](/docs/tasks/concluidos/CORR-WTE-055.md) | Correção: a WTE-TASK-24 chama de 322 os imports de `rtl60`/`vcl60`, e eles são 267 | WTE-TASK-24 | low | done | 2026-08-11 |
| [CORR-WTE-056](/docs/tasks/concluidos/CORR-WTE-056.md) | Correção: três sítios ainda mandam rodar `apply_names.py`, e o script é `.java` | WTE-TASK-24 | low | done | 2026-08-11 |
| [CORR-WTE-057](/docs/tasks/concluidos/CORR-WTE-057.md) | Correção: a conferência de tela cobre 3 dos 5 grupos de campo que o critério enumera | WTE-TASK-25 | high | done | 2026-08-11 |
| [CORR-WTE-058](/docs/tasks/concluidos/CORR-WTE-058.md) | Correção: o `visual.md` manda rodar o `capture_forms.sh`, que a WTE-TASK-25 removeu | WTE-TASK-25 | low | done | 2026-08-11 |
| [CORR-WTE-059](/docs/tasks/concluidos/CORR-WTE-059.md) | Correção: a spec do `lista_equiposChange` dá para o veredito `aberto` uma razão que a seção seguinte desmente | WTE-TASK-25 | low | done | 2026-08-11 |
| [CORR-WTE-060](/docs/tasks/concluidos/CORR-WTE-060.md) | Correção: o `iguala_nombres` não acinzenta no port, e o defeito atravessou duas tasks sem correção própria | WTE-TASK-26 | high | done | 2026-08-18 |
| [CORR-WTE-061](/docs/tasks/concluidos/CORR-WTE-061.md) | Correção: o `MaxLength` de `edit_nombre1` é o literal 5, lido da tela, sem lastro no formato | WTE-TASK-26 | low | done | 2026-08-18 |
| [CORR-WTE-062](/docs/tasks/concluidos/CORR-WTE-062.md) | Correção: o `lista_formacionesClick` ficou entre duas tasks concluídas e continua `REStub` | WTE-TASK-25 | high | done | 2026-08-18 |
| [CORR-WTE-063](/docs/tasks/concluidos/CORR-WTE-063.md) | Correção: cara, cabelo e barba da ficha não têm dono em nenhuma das 40 tasks | WTE-TASK-26 | high | done | 2026-08-18 |
| [CORR-WTE-064](/docs/tasks/concluidos/CORR-WTE-064.md) | Correção: o lote do `edit_nombre1` está provado e a conta dá um a mais que o oráculo | WTE-TASK-26 | medium | done | 2026-08-18 |
| [CORR-WTE-065](/docs/tasks/concluidos/CORR-WTE-065.md) | Correção: "o maior b0 medido é 43" — é 111 na europeia e 116 na japonesa | WTE-TASK-33 | high | done | 2026-08-19 |
| [CORR-WTE-066](/docs/tasks/concluidos/CORR-WTE-066.md) | Correção: a tabela de endereços atropelados lista um que nunca é alcançado e esconde o quarto | WTE-TASK-33 | high | done | 2026-08-19 |
| [CORR-WTE-067](/docs/tasks/concluidos/CORR-WTE-067.md) | Correção: a nota nova da WTE-TASK-27 põe a AtualizaBlocosLivresDeMl na unidade errada e promete um mapa que não existe | WTE-TASK-33 | low | done | 2026-08-19 |
| [CORR-WTE-068](/docs/tasks/concluidos/CORR-WTE-068.md) | Correção: três specs de gravação ainda dizem que o gate passa "só as duas faixas do arranque", e hoje ele é byte-idêntico | WTE-TASK-27 | high | done | 2026-08-20 |
| [CORR-WTE-069](/docs/tasks/concluidos/CORR-WTE-069.md) | Correção: as três funções novas do we2002_ml entraram no caminho de gravação sem um teste sequer | WTE-TASK-27 | low | done | 2026-08-20 |
| [CORR-WTE-070](/docs/tasks/concluidos/CORR-WTE-070.md) | Correção: a tabela "Arquivos a criar ou modificar" da WTE-TASK-27 aponta para arquivos que não existem | WTE-TASK-27 | low | done | 2026-08-20 |
| [CORR-WTE-071](/docs/tasks/concluidos/CORR-WTE-071.md) | Correção: o mapa do .mcr diz 16 destinos, e a tabela dele tem 17 | WTE-TASK-28 | high | done | 2026-08-20 |
| [CORR-WTE-072](/docs/tasks/concluidos/CORR-WTE-072.md) | Correção: gravacao-controle.md fecha com a premissa que a WTE-TASK-28 refutou | WTE-TASK-28 | high | done | 2026-08-20 |
| [CORR-WTE-073](/docs/tasks/concluidos/CORR-WTE-073.md) | Correção: check_lcl_combo.py ficou preso no :99 depois da mudança para o :98 | WTE-TASK-28 | high | done | 2026-08-20 |
| [CORR-WTE-074](/docs/tasks/concluidos/CORR-WTE-074.md) | Correção: a confrontação Pascal × Python do .mcr aponta para um arquivo transitório | WTE-TASK-28 | low | done | 2026-08-20 |
| [CORR-WTE-075](/docs/tasks/concluidos/CORR-WTE-075.md) | Correção: o teste do round-trip sobrescreve a medição versionada e a repõe na mão | WTE-TASK-28 | low | done | 2026-08-20 |
| [CORR-WTE-076](/docs/tasks/concluidos/CORR-WTE-076.md) | Correção: o plano e a task dizem 758 linhas de DFM no ficha_color, e o extrator dá 866 | WTE-TASK-29 | high | done | 2026-08-21 |
| [CORR-WTE-077](/docs/tasks/concluidos/CORR-WTE-077.md) | Correção: a §5.3 do plano ainda manda varrer pixel, e a WTE-TASK-29 mediu que é paleta | WTE-TASK-29 | high | done | 2026-08-21 |
| [CORR-WTE-078](/docs/tasks/concluidos/CORR-WTE-078.md) | Correção: o Log da sétima passagem conta 7 casos novos no test_dump_zonas.py, e são 9 | WTE-TASK-29 | low | done | 2026-08-21 |
| [CORR-WTE-079](/docs/tasks/concluidos/CORR-WTE-079.md) | Correção: o compara_tela.sh ficou com dois blocos de --malha colados no lugar errado | WTE-TASK-29 | low | done | 2026-08-21 |
| [CORR-WTE-080](/docs/tasks/concluidos/CORR-WTE-080.md) | Correção: o golden-14-uniforme falha por tempo em boa parte das corridas | WTE-TASK-29 | high | done | 2026-08-21 |
| [CORR-WTE-081](/docs/tasks/concluidos/CORR-WTE-081.md) | Correção: três gravações na imagem sem dono — o OK do ficha_color, o Comple. do jugador e o Accept do estrategia | WTE-TASK-30 | high | done | 2026-08-21 |
| [CORR-WTE-082](/docs/tasks/concluidos/CORR-WTE-082.md) | Correção: a tela de tática não é enchida, e sem isso o ` Accept` do estrategia grava as coordenadas do .lfm | CORR-WTE-081 | high | done | 2026-08-21 |
| [CORR-WTE-083](/docs/tasks/concluidos/CORR-WTE-083.md) | Correção: dez times desenham bandeira preta — o ed.exe não lê a paleta deles, e o editor do Obocaman lê | WTE-TASK-31 | high | done | 2026-08-23 |
| [CORR-WTE-084](/docs/tasks/concluidos/CORR-WTE-084.md) | Correção: a bandeira do ml_teams[22] sai 2 px mais abaixo, e a barra `equipe` do oráculo sai fora da grade | CORR-WTE-083 | medium | done | 2026-08-23 |
| [CORR-WTE-085](/docs/tasks/concluidos/CORR-WTE-085.md) | Correção: o plano e o progresso ainda dizem "seis gravações" onde a ferramenta mede dezessete | WTE-TASK-30 | high | done | 2026-08-23 |
| [CORR-WTE-086](/docs/tasks/concluidos/CORR-WTE-086.md) | Correção: o dono do ficha_enlaza não é o pabajoClick — nenhuma spec ou código liga os dois | WTE-TASK-30 | low | done | 2026-08-23 |
| [CORR-WTE-087](/docs/tasks/concluidos/CORR-WTE-087.md) | Correção: o Log da WTE-TASK-30 conta 12 .inc novos e 6 .uses tocados; são 11 e 5 | WTE-TASK-30 | low | done | 2026-08-23 |
| [CORR-WTE-088](/docs/tasks/concluidos/CORR-WTE-088.md) | Correção: nove comentários de comportamento corrente ainda dizem :99 depois da mudança para o :98 | WTE-TASK-30 | low | done | 2026-08-23 |
| [CORR-WTE-089](/docs/tasks/concluidos/CORR-WTE-089.md) | Correção: três vereditos `aberto` por 'nada exercita o corpo' quando a bateria golden já os exercita | WTE-TASK-31 | high | done | 2026-08-24 |
| [CORR-WTE-090](/docs/tasks/concluidos/CORR-WTE-090.md) | Correção: três vereditos `aberto` esperando decisão que já foi tomada, ou que pertence a outra fase | WTE-TASK-31 | high | done | 2026-08-24 |
| [CORR-WTE-091](/docs/tasks/concluidos/CORR-WTE-091.md) | Correção: o `Original ` da ficha esperava uma mudança de estrutura, e a régua dele precisa ser um par | WTE-TASK-31 | high | done | 2026-08-24 |
| [CORR-WTE-092](/docs/tasks/concluidos/CORR-WTE-092.md) | Correção: dois handlers sem estímulo — o ramo do reserva e o arrasto de bola | WTE-TASK-31 | high | done | 2026-08-24 |
| [CORR-WTE-093](/docs/tasks/concluidos/CORR-WTE-093.md) | Correção: os dois últimos corpos da fase 4 — a tela de tática e o diálogo de textura | WTE-TASK-31 | high | done | 2026-08-24 |
| [CORR-WTE-094](/docs/tasks/concluidos/CORR-WTE-094.md) | Correção: a premissa da WTE-TASK-32 está errada — o `ed.exe` calcula preço, o que ele não tem é o botão | WTE-TASK-31 | medium | done | 2026-08-24 |
| [CORR-WTE-095](/docs/tasks/concluidos/CORR-WTE-095.md) | Investigar: o editor do Obocaman nunca preça o slot 22, e o `ed.exe` diz que ele tem preço | WTE-TASK-32 | medium | done | 2026-08-24 |
| [CORR-WTE-096](/docs/tasks/concluidos/CORR-WTE-096.md) | Correção: chave duplicada no GOLDEN_DE apaga o gate do base_teamClick, e o fase-4.md publica "nenhum" | WTE-TASK-32 | high | done | 2026-08-24 |
| [CORR-WTE-097](/docs/tasks/concluidos/CORR-WTE-097.md) | Correção: o comentário do base_teamClick diz "medido em dois times" e a medida final tem seis | WTE-TASK-32 | low | done | 2026-08-24 |
| [CORR-WTE-098](/docs/tasks/concluidos/CORR-WTE-098.md) | Correção: a §5.1 do plano ainda diz que o preço não precisa de golden, e ele tem um | WTE-TASK-32 | medium | done | 2026-08-24 |
| [CORR-WTE-099](/docs/tasks/concluidos/CORR-WTE-099.md) | Correção: a lista de arquivos da WTE-TASK-32 não menciona a mudança no .gitignore | WTE-TASK-32 | low | done | 2026-08-24 |
| [CORR-WTE-100](/docs/tasks/concluidos/CORR-WTE-100.md) | Correção: a citação `{$Q-}` num comentário abre nível 2 — o único warning do build, e um erro fatal em modo delphi | CORR-WTE-095 | low | done | 2026-08-24 |
| [CORR-WTE-101](/docs/tasks/concluidos/CORR-WTE-101.md) | Correção: "seis seções obrigatórias" onde o gabarito e a ferramenta têm cinco, e a conta de 481 é só delas | WTE-TASK-31 | medium | done | 2026-08-24 |
| [CORR-WTE-102](/docs/tasks/concluidos/CORR-WTE-102.md) | Correção: quatro sítios vivos ainda dizem "as 94 specs" onde o índice conta 96 | WTE-TASK-31 | medium | done | 2026-08-24 |
| [CORR-WTE-103](/docs/tasks/concluidos/CORR-WTE-103.md) | Correção: no estado zero o fase-4.md perde a linha em branco antes do título seguinte | WTE-TASK-31 | low | done | 2026-08-24 |
| [CORR-WTE-104](/docs/tasks/concluidos/CORR-WTE-104.md) | Correção: o golden-24 grava duas vezes num time cujos dois primeiros cobradores são iguais — o vaivém seria invisível | WTE-TASK-34 | high | done | 2026-08-25 |
| [CORR-WTE-105](/docs/tasks/concluidos/CORR-WTE-105.md) | Correção: a pendência que a WTE-TASK-34 encaminhou para a 35 não existe na 35 | WTE-TASK-34 | low | done | 2026-08-25 |
| [CORR-WTE-106](/docs/tasks/concluidos/CORR-WTE-106.md) | Correção: o check_divergencias.py é o único gate de recusa sem teste — as "três recusas vistas" não deixaram artefato | WTE-TASK-35 | medium | done | 2026-08-25 |
| [CORR-WTE-107](/docs/tasks/concluidos/CORR-WTE-107.md) | Correção: a lista de arquivos da WTE-TASK-35 não menciona o repasse escrito na WTE-TASK-36 | WTE-TASK-35 | low | done | 2026-08-25 |
| [CORR-WTE-108](/docs/tasks/concluidos/CORR-WTE-108.md) | Correção: a WTE-TASK-35 deixa "o plano é o que falta conferir" e o plano nunca afirmou aquilo | WTE-TASK-35 | low | done | 2026-08-25 |
| [CORR-WTE-109](/docs/tasks/concluidos/CORR-WTE-109.md) | Correção: quatro sítios do lado WTE atribuem a não-idempotência ao "editor original", que aqui é o wte.exe — e o único caminho medido não a tem | WTE-TASK-35 | medium | done | 2026-08-25 |
| [CORR-WTE-110](/docs/tasks/concluidos/CORR-WTE-110.md) | Correção: os quatro casos de borda foram medidos num vetor só, e o critério diz "por campo" | WTE-TASK-36 | medium | done | 2026-08-25 |
| [CORR-WTE-111](/docs/tasks/concluidos/CORR-WTE-111.md) | Correção: o campo `faixa` do CAMPOS é dado morto, e dois dos quatro valores contradizem o medido | WTE-TASK-36 | low | done | 2026-08-25 |
| [CORR-WTE-112](/docs/tasks/concluidos/CORR-WTE-112.md) | Correção: o `filtro` de cada campo é publicado no buffers.md e nunca conferido contra o KeyPress | WTE-TASK-36 | low | done | 2026-08-25 |
| [CORR-WTE-113](/docs/tasks/concluidos/CORR-WTE-113.md) | Correção: `golden_suite.sh --roteiro` trunca o `golden.tsv` inteiro — 96 corridas viram zero | WTE-TASK-37 | high | done | 2026-08-25 |
| [CORR-WTE-114](/docs/tasks/concluidos/CORR-WTE-114.md) | Correção: três divergências novas ficaram numa task concluída, e o registro que existe para elas não as tem | WTE-TASK-37 | medium | done | 2026-08-25 |
| [CORR-WTE-115](/docs/tasks/concluidos/CORR-WTE-115.md) | Correção: o check_carregado.py aborta e não tem teste, enquanto o irmão nascido no mesmo commit tem | WTE-TASK-37 | low | done | 2026-08-25 |
| [CORR-WTE-116](/docs/tasks/concluidos/CORR-WTE-116.md) | Correção: o controle do `trace.log` diz "mkdir re ao lado da cópia", e ao lado da cópia não funciona | WTE-TASK-38 | low | done | 2026-08-25 |
| [CORR-WTE-117](/docs/tasks/concluidos/CORR-WTE-117.md) | Correção: o app procura os assets em quatro lugares e a mensagem promete três, sem dizer o que é o quarto | WTE-TASK-39 | medium | done | 2026-08-26 |
| [CORR-WTE-118](/docs/tasks/concluidos/CORR-WTE-118.md) | Correção: a seção de renomeação da WTE-TASK-39 ainda manda renomear o que a própria task decidiu não renomear | WTE-TASK-39 | low | done | 2026-08-26 |
| [CORR-WTE-119](/docs/tasks/concluidos/CORR-WTE-119.md) | Correção: o nativo.md repete os sete valores do nativo.tsv e nada amarra os dois | WTE-TASK-40 | medium | done | 2026-08-26 |
| [CORR-WTE-120](/docs/tasks/concluidos/CORR-WTE-120.md) | Correção: a guarda do sem_wine.sh é creditada à metade que nesta máquina não pode disparar | WTE-TASK-40 | low | done | 2026-08-26 |
| [CORR-WTE-121](/docs/tasks/concluidos/CORR-WTE-121.md) | Correção: o port grava três faixas de nome de time diferentes do oráculo, e só a ptbr-remaster expõe | WTE-TASK-34 | high | done | 2026-08-28 |
| [CORR-WTE-122](/docs/tasks/concluidos/CORR-WTE-122.md) | Correção: o progresso.md ainda chama o hook do lado do port de GOLDEN_EDIT, nome que o golden_gui.sh não lê | PAR-TASK-01 | medium | done | 2026-08-28 |
| [CORR-WTE-123](/docs/tasks/concluidos/CORR-WTE-123.md) | Correção: os seis roteiros da PAR-TASK-01 não estão em lugar nenhum, e a 'Definição de pronto' promete o comando | PAR-TASK-01 | high | done | 2026-08-28 |
| [CORR-WTE-124](/docs/tasks/concluidos/CORR-WTE-124.md) | Correção: CMD_DEFAULT_NUMBERS grava 37 faixas no port contra 20 no ed.exe | PAR-TASK-02 | high | done | 2026-08-29 |
| [CORR-WTE-125](/docs/tasks/concluidos/CORR-WTE-125.md) | Correção: Escape num combo de cobrador descarta a navegação no port e não no ed.exe | PAR-TASK-03 | high | done | 2026-08-29 |
| [CORR-WTE-126](/docs/tasks/concluidos/CORR-WTE-126.md) | Correção: os itens 1 e 2 da §8.2 não têm roteiro versionado, e a §8.2 é a única seção fora da convenção que a CORR-WTE-123 fixou | PAR-TASK-02 | high | done | 2026-08-29 |
| [CORR-WTE-127](/docs/tasks/concluidos/CORR-WTE-127.md) | Correção: o Escape da CORR-WTE-125 continua divergindo nos dez combos de papel, e a razão dada para excluí-los não bate com o código | PAR-TASK-03 | high | done | 2026-08-29 |
| [CORR-WTE-128](/docs/tasks/concluidos/CORR-WTE-128.md) | Correção: o item 1 da §8.4 não tem roteiro, e a seção afirma que os cinco têm | PAR-TASK-04 | high | done | 2026-08-29 |
| [CORR-WTE-129](/docs/tasks/concluidos/CORR-WTE-129.md) | Correção: o Log da PAR-TASK-04 põe o CMD_SKILLS1 em dlu (392,36); o controle está em (382,32) | PAR-TASK-04 | low | done | 2026-08-29 |
| [CORR-WTE-130](/docs/tasks/concluidos/CORR-WTE-130.md) | Correção: o roteiro da §8.5 troca completa por incompleta, e o PAR_INCOMPLETE=1 roda a completa | PAR-TASK-05 | medium | done | 2026-08-29 |
| [CORR-WTE-131](/docs/tasks/concluidos/CORR-WTE-131.md) | Correção: as edições do DefaultTacticsDialog não chegam ao disco no port, e chegam no ed.exe | PAR-TASK-06 | high | done | 2026-08-30 |
| [CORR-WTE-132](/docs/tasks/concluidos/CORR-WTE-132.md) | Correção: nenhuma — os 52 bytes do port é que estão certos; quem diverge é o ed.exe x64 | PAR-TASK-06 | high | done | 2026-09-01 |
| [CORR-WTE-133](/docs/tasks/concluidos/CORR-WTE-133.md) | Correção: os dois lados liam defaultlook.txt diferentes — fixture do oráculo fora de sincronia | PAR-TASK-08 | medium | done | 2026-09-01 |
| [CORR-WTE-134](/docs/tasks/concluidos/CORR-WTE-134.md) | Correção: o `Escape` nos dez combos de papel do `DefaultTacticsDialog` diverge do original | PAR-TASK-06 | high | done | 2026-08-31 |
| [CORR-WTE-135](/docs/tasks/concluidos/CORR-WTE-135.md) | Correção: o item 5 da §8.7 (`.t2002`) foi fechado sem veredito de golden | PAR-TASK-06 | high | done | 2026-08-31 |
| [CORR-WTE-136](/docs/tasks/concluidos/CORR-WTE-136.md) | Correção: a §8.7 conta seis roteiros onde há oito, e o Log erra o ordinal do item da CORR-WTE-127 | PAR-TASK-06 | low | done | 2026-08-31 |
| [CORR-WTE-137](/docs/tasks/concluidos/CORR-WTE-137.md) | Correção: `8.8-b2002-exportar.sh` não reproduz, não confere nada e deixa o modal aberto | PAR-TASK-07 | high | done | 2026-08-31 |
| [CORR-WTE-138](/docs/tasks/concluidos/CORR-WTE-138.md) | Correção: os ids 69 e 86 do item 2 da §8.8 estão marcados sem terem sido medidos | PAR-TASK-07 | low | done | 2026-08-31 |
| [CORR-WTE-139](/docs/tasks/concluidos/CORR-WTE-139.md) | Correção: `Return` depois de clicar um botão do `DefaultTacticsDialog` reabre o botão no port e fecha o diálogo no original | CORR-WTE-135 | medium | done | 2026-08-31 |
| [CORR-WTE-140](/docs/tasks/concluidos/CORR-WTE-140.md) | Correção: cancelar o diálogo de abertura encerra o port e deixa o `ed.exe` com a janela vazia | PAR-TASK-09 | medium | done | 2026-08-31 |
| [CORR-WTE-141](/docs/tasks/concluidos/CORR-WTE-141.md) | Correção: `Return` na janela principal encerra o `ed.exe` e não faz nada no port | PAR-TASK-09 | medium | done | 2026-08-31 |
| [CORR-WTE-142](/docs/tasks/concluidos/CORR-WTE-142.md) | Correção: os roteiros de ciclo de vida gravam captura em `/tmp/c09`, que ninguém cria — e o do oráculo anuncia a captura que não fez | PAR-TASK-09 | high | done | 2026-08-31 |
| [CORR-WTE-143](/docs/tasks/concluidos/CORR-WTE-143.md) | Correção: `8.10-return-nao-dispara.sh` é chamado de hook de golden, mas `golden_check.sh` com ele sempre reprova | PAR-TASK-09 | low | done | 2026-08-31 |
<!-- rite:end -->
