...
|---|---|---|---|---|---|
| [CORR-WTE-001](/docs/tasks/concluidos/CORR-WTE-001.md) | [WTE-TASK-01](/docs/tasks/concluidos/01-ferramental.md) | Frontmatter da task diz `pendente` numa tarefa concluída | Baixa | [x] concluída | 2026-08-05 |
| [CORR-WTE-002](/docs/tasks/concluidos/CORR-WTE-002.md) | [WTE-TASK-01](/docs/tasks/concluidos/01-ferramental.md) | Dois números do `ambiente.md` só são reproduzíveis pelo scratchpad | Baixa | [x] concluída | 2026-08-05 |
| [CORR-WTE-003](/docs/tasks/concluidos/CORR-WTE-003.md) | [WTE-TASK-02](/docs/tasks/concluidos/02-esqueleto-do-projeto.md) | A seção `wte/` do `.gitignore` ignora `lib/` e `backup/` no repositório inteiro | Baixa | [x] concluída | 2026-08-05 |
| [CORR-WTE-004](/docs/tasks/concluidos/CORR-WTE-004.md) | [WTE-TASK-03](/docs/tasks/concluidos/03-extrator-de-dfm.md) | `--check` fica vermelho num clone limpo, porque `blobs/` é gitignored | Baixa | [x] concluída | 2026-08-05 |
| [CORR-WTE-005](/docs/tasks/concluidos/CORR-WTE-005.md) | [WTE-TASK-03](/docs/tasks/concluidos/03-extrator-de-dfm.md) | Os streams sintéticos que sustentam "os 21 `TValueType` exercitados" não são versionados | Baixa | [x] concluída | 2026-08-06 |
| [CORR-WTE-006](/docs/tasks/concluidos/CORR-WTE-006.md) | [WTE-TASK-04](/docs/tasks/concluidos/04-mapa-de-handlers.md) | Os fatos medidos pela WTE-TASK-04 não chegaram aos seis documentos que serão executados | Alta | [x] concluída | 2026-08-06 |
| [CORR-WTE-007](/docs/tasks/concluidos/CORR-WTE-007.md) | [WTE-TASK-04](/docs/tasks/concluidos/04-mapa-de-handlers.md) | A tabela de envelhecimento do `published_methods.md` erra uma atribuição e omite três divergências | Baixa | [x] concluída | 2026-08-06 |
| [CORR-WTE-008](/docs/tasks/concluidos/CORR-WTE-008.md) | [WTE-TASK-05](/docs/tasks/concluidos/05-inventario-de-strings.md) | O decodificador de instrução x86 só foi conferido à mão, e a coluna `handler` inteira depende dele | Baixa | [x] concluída | 2026-08-06 |
| [CORR-WTE-009](/docs/tasks/concluidos/CORR-WTE-009.md) | [WTE-TASK-05](/docs/tasks/concluidos/05-inventario-de-strings.md) | A §8.8 e a pendência do `progresso.md` ainda tratam o binário espanhol como única rota para as mensagens decepadas | Baixa | [x] concluída | 2026-08-06 |
| [CORR-WTE-010](/docs/tasks/concluidos/CORR-WTE-010.md) | [WTE-TASK-06](/docs/tasks/concluidos/06-mapa-de-offsets.md) | A §8.7 do plano aponta o lado errado da tabela, e o ASCII citado não é o do binário | Alta | [x] concluída | 2026-08-06 |
| [CORR-WTE-011](/docs/tasks/concluidos/CORR-WTE-011.md) | [WTE-TASK-06](/docs/tasks/concluidos/06-mapa-de-offsets.md) | O critério de limite do `dump_offsets.py` aborta num sentido só, e a janela de plausibilidade sai do nosso `Offsets.hpp` | Baixa | [x] concluída | 2026-08-06 |
| [CORR-WTE-012](/docs/tasks/concluidos/CORR-WTE-012.md) | [WTE-TASK-07](/docs/tasks/concluidos/07-unidades-duvidosas.md) | A §1 do plano diz 300 imports de `rtl60`/`vcl60` (são 267) e chama o `TBrowseURL` de componente de terceiro | Alta | [x] concluída | 2026-08-06 |
| [CORR-WTE-013](/docs/tasks/concluidos/CORR-WTE-013.md) | [WTE-TASK-07](/docs/tasks/concluidos/07-unidades-duvidosas.md) | O decodificador x86 do `dump_units.py` é cópia verbatim do `dump_strings.py` e nenhum teste o alcança | Baixa | [x] concluída | 2026-08-06 |
| [CORR-WTE-014](/docs/tasks/concluidos/CORR-WTE-014.md) | [WTE-TASK-08](/docs/tasks/concluidos/08-convencao-dos-assets.md) | O "197 bitmaps" (são 198) não está no quadro de reconciliação da WTE-TASK-09 e sobrevive em nove lugares | Alta | [x] concluída | 2026-08-06 |
| [CORR-WTE-015](/docs/tasks/concluidos/CORR-WTE-015.md) | [WTE-TASK-08](/docs/tasks/concluidos/08-convencao-dos-assets.md) | Duas transcrições de evidência do `assets.md` não batem: o ano dos 195 `.bmp` e o endereço do `fread` | Baixa | [x] concluída | 2026-08-06 |
| [CORR-WTE-016](/docs/tasks/concluidos/CORR-WTE-016.md) | [WTE-TASK-09](/docs/tasks/concluidos/09-fechamento-fase-1.md) | A varredura de sítios para em `docs/` e `wte/re/`, e o `wte/README.md` ainda diz que a §1 do plano registra 197 bitmaps | Baixa | [x] concluída | 2026-08-06 |
| [CORR-WTE-017](/docs/tasks/concluidos/CORR-WTE-017.md) | [WTE-TASK-09](/docs/tasks/concluidos/09-fechamento-fase-1.md) | O `fase-1.md` separa offset de tabela de offset em `.text` por substring do endereço, e a igualdade que a prosa afirma não é conferida | Baixa | [x] concluída | 2026-08-06 |
| [CORR-WTE-018](/docs/tasks/concluidos/CORR-WTE-018.md) | [WTE-TASK-09](/docs/tasks/concluidos/09-fechamento-fase-1.md) | O `02-revisar.md` cita `~430`, `70` e `197` como "o que já está no plano", e o plano não diz mais isso | Baixa | [x] concluída | 2026-08-09 |
| [CORR-WTE-019](/docs/tasks/concluidos/CORR-WTE-019.md) | [WTE-TASK-10](/docs/tasks/concluidos/10-conversor-dfm-para-lfm.md) | A reversão que versionou 816.880 bytes de arte do Obocaman só está registrada num README derivado | Alta | [x] concluída | 2026-08-09 |
| [CORR-WTE-020](/docs/tasks/concluidos/CORR-WTE-020.md) | [WTE-TASK-10](/docs/tasks/concluidos/10-conversor-dfm-para-lfm.md) | A tabela `ACEITA`/`DESCARTA` diz ter sido medida na LCL 3.0 e nada remede; `LCL_VERSAO` é código morto | Alta | [x] concluída | 2026-08-09 |
| [CORR-WTE-021](/docs/tasks/concluidos/CORR-WTE-021.md) | [WTE-TASK-10](/docs/tasks/concluidos/10-conversor-dfm-para-lfm.md) | O critério "blobs visíveis na janela" foi adiado para a WTE-TASK-11, que não o tem | Baixa | [x] concluída | 2026-08-09 |
| [CORR-WTE-022](/docs/tasks/concluidos/CORR-WTE-022.md) | [WTE-TASK-11](/docs/tasks/concluidos/11-app-com-a-casca-completa.md) | O comando publicado da ordem de auto-create devolve 17 das 18 classes, e perde justamente `TMainForm` | Alta | [x] concluída | 2026-08-09 |
| [CORR-WTE-023](/docs/tasks/concluidos/CORR-WTE-023.md) | [WTE-TASK-11](/docs/tasks/concluidos/11-app-com-a-casca-completa.md) | O critério de build diz 2.482 linhas (são 2.562) e atribui os 2 hints ao Lazarus (são do `/etc/fpc.cfg`) | Alta | [x] concluída | 2026-08-09 |
| [CORR-WTE-024](/docs/tasks/concluidos/CORR-WTE-024.md) | [WTE-TASK-11](/docs/tasks/concluidos/11-app-com-a-casca-completa.md) | O sufixo ` [Lazarus]` não chegou à WTE-TASK-35 e o `--show` não chegou à WTE-TASK-12 | Baixa | [x] concluída | 2026-08-09 |
| [CORR-WTE-025](/docs/tasks/concluidos/CORR-WTE-025.md) | [WTE-TASK-12](/docs/tasks/concluidos/12-comparacao-visual.md) | A faixa `11797..26528` é posição do `cmp -l`, e a WTE-TASK-22 vai declará-la como offset | Alta | [x] concluída | 2026-08-09 |
| [CORR-WTE-026](/docs/tasks/concluidos/CORR-WTE-026.md) | [WTE-TASK-13](/docs/tasks/concluidos/13-trace-de-eventos.md) | A tabela do achado 2 se anuncia medida, e a coluna VCL não foi medida | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-027](/docs/tasks/concluidos/CORR-WTE-027.md) | [WTE-TASK-14](/docs/tasks/concluidos/14-fechamento-fase-2.md) | O `fase-2.md` emite link `/docs/...` de dentro de `wte/re/`, fora do perímetro da regra | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-028](/docs/tasks/concluidos/CORR-WTE-028.md) | [WTE-TASK-14](/docs/tasks/concluidos/14-fechamento-fase-2.md) | `conferir_vereditos()` guarda a coluna `Original`, não o veredito | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-029](/docs/tasks/concluidos/CORR-WTE-029.md) | [WTE-TASK-16](/docs/tasks/concluidos/16-gerador-de-tabelas.md) | O Log diz que a reconciliação do `fase-2.md` saiu em commit próprio, e ela saiu no mesmo | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-030](/docs/tasks/concluidos/CORR-WTE-030.md) | [WTE-TASK-15](/docs/tasks/concluidos/15-mapeamento-de-tipo.md) | O `tipos.md` conta 38 `strcpy`, e o `Database.cpp` tem 40 — os dois que faltam são `std::strcpy` | Alta | [x] concluída | 2026-08-10 |
| [CORR-WTE-031](/docs/tasks/concluidos/CORR-WTE-031.md) | [WTE-TASK-16](/docs/tasks/concluidos/16-gerador-de-tabelas.md) | O `wte/tests/README.md` diz que a pasta está vazia e é só Pascal; tem dois arquivos, um em C++ | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-032](/docs/tasks/concluidos/CORR-WTE-032.md) | [WTE-TASK-15](/docs/tasks/concluidos/15-mapeamento-de-tipo.md) | A "regra zero" do `tipos.md` proíbe `LongInt` e `SizeInt` em campo de registro, e a tabela usa os dois | Alta | [x] concluída | 2026-08-10 |
| [CORR-WTE-034](/docs/tasks/concluidos/CORR-WTE-034.md) | [WTE-TASK-15](/docs/tasks/concluidos/15-mapeamento-de-tipo.md) | A "entrada real medida" do `tipos.md` omite os cabeçalhos que declaram os campos que a tabela mapeia | Alta | [x] concluída | 2026-08-10 |
| [CORR-WTE-035](/docs/tasks/concluidos/CORR-WTE-035.md) | [WTE-TASK-15](/docs/tasks/concluidos/15-mapeamento-de-tipo.md) | A decisão 5 do `tipos.md` não tem o "teste que prova", e o critério que o exige está marcado | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-036](/docs/tasks/concluidos/CORR-WTE-036.md) | [WTE-TASK-17](/docs/tasks/concluidos/17-transpilador-da-camada-de-dados.md) | A regra `!` → `not` do `SUBS` atravessa a quebra de linha e engole seis statements para dentro de comentário | Alta | [x] concluída | 2026-08-10 |
| [CORR-WTE-037](/docs/tasks/concluidos/CORR-WTE-037.md) | [WTE-TASK-17](/docs/tasks/concluidos/17-transpilador-da-camada-de-dados.md) | A linha das recusas medidas na saída está deslocada, e o worklist da WTE-TASK-18 aponta para a linha errada | Alta | [x] envelhecida | 2026-08-10 |
| [CORR-WTE-038](/docs/tasks/concluidos/CORR-WTE-038.md) | [WTE-TASK-17](/docs/tasks/concluidos/17-transpilador-da-camada-de-dados.md) | O Log da WTE-TASK-17 diz 41 regras de substituição, e o gerador tem 47 | Alta | [x] concluída | 2026-08-10 |
| [CORR-WTE-039](/docs/tasks/concluidos/CORR-WTE-039.md) | [WTE-TASK-23](/docs/tasks/concluidos/23-formato-da-spec.md) | O `GABARITO.md` diz que o gerador recusa `(int)*(int *)`, e ele aceita | Alta | [x] concluída | 2026-08-10 |
| [CORR-WTE-040](/docs/tasks/concluidos/CORR-WTE-040.md) | [WTE-TASK-23](/docs/tasks/concluidos/23-formato-da-spec.md) | O `GABARITO.md` diz quatro famílias de `BitBtnNClick`, e o TSV tem três nomes | Alta | [x] concluída | 2026-08-10 |
| [CORR-WTE-041](/docs/tasks/concluidos/CORR-WTE-041.md) | [WTE-TASK-23](/docs/tasks/concluidos/23-formato-da-spec.md) | Quatro das 15 rotas de recusa do `spec_index.py` não têm teste, e o README chama as onze testadas de "as" rotas | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-042](/docs/tasks/concluidos/CORR-WTE-042.md) | [WTE-TASK-18](/docs/tasks/concluidos/18-camada-de-dados-gerada.md) | O Log da WTE-TASK-18 diz que os testes do transpilador eram 33, e eram 38 | Alta | [x] concluída | 2026-08-10 |
| [CORR-WTE-043](/docs/tasks/concluidos/CORR-WTE-043.md) | [WTE-TASK-18](/docs/tasks/concluidos/18-camada-de-dados-gerada.md) | `players[i].cost := Ord(buf1[0])` perde o sinal que o `char` do C++ tem | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-044](/docs/tasks/concluidos/CORR-WTE-044.md) | [WTE-TASK-19](/docs/tasks/concluidos/19-os-50-offsets-restantes.md) | O oráculo comportamental está morto e a fase 4 é circular: o gate 22 precisa do `wte.exe` vivo, e entendê-lo é a WTE-TASK-25, que depende do 22 | Alta | [x] concluída | 2026-08-10 |
| [CORR-WTE-045](/docs/tasks/concluidos/CORR-WTE-045.md) | [WTE-TASK-19](/docs/tasks/concluidos/19-os-50-offsets-restantes.md) | A seção das seis áreas do `offsets-novos.md` diz `roms/09-areas-com-time`, que é o nome da sessão — a imagem é `japanese-shift-jis.bin` | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-046](/docs/tasks/concluidos/CORR-WTE-046.md) | [WTE-TASK-19](/docs/tasks/concluidos/19-os-50-offsets-restantes.md) | Três dos 14 vereditos `retomada de fronteira` provam com `case N`, e o `Database.cpp` tem `if(i == N)` — num deles o `case N` existe em outro bloco | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-047](/docs/tasks/concluidos/CORR-WTE-047.md) | [WTE-TASK-19](/docs/tasks/concluidos/19-os-50-offsets-restantes.md) | As sessões 10 e 11, que deram 18 dos 33 endereçados, não têm o resultado da segunda régua (`cmp`) registrado em lugar nenhum | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-048](/docs/tasks/concluidos/CORR-WTE-048.md) | [WTE-TASK-20](/docs/tasks/concluidos/20-round-trip-headless.md) | O `fase-3.md` gerado ainda diz que o `wte.exe` não passa da tela de carga — o sweep da CORR-WTE-044 varreu quatro arquivos e não este | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-049](/docs/tasks/concluidos/CORR-WTE-049.md) | [WTE-TASK-20](/docs/tasks/concluidos/20-round-trip-headless.md) | O parágrafo de dependência da WTE-TASK-20 diz que os 36 restantes são "os que o `we2002_core` não tem", e os 50 `ausente` são todos do `Offsets.hpp`; e cita a 19 como bloqueada | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-050](/docs/tasks/concluidos/CORR-WTE-050.md) | [WTE-TASK-21](/docs/tasks/concluidos/21-fechamento-fase-3.md) | A razão entrada × saída divide as 3.692 linhas dos dois geradores pelas 2.504 de entrada de um só; as 852 do `gen_tables_pas` ficam fora do denominador | Alta | [x] concluída | 2026-08-10 |
| [CORR-WTE-051](/docs/tasks/concluidos/CORR-WTE-051.md) | [WTE-TASK-21](/docs/tasks/concluidos/21-fechamento-fase-3.md) | A fração de 92,5% subtrai 277 linhas úteis de um total de 3.692 que conta linha em branco — 26 linhas em branco de bloco manual entram como "por regra" | Baixa | [x] concluída | 2026-08-10 |
| [CORR-WTE-052](/docs/tasks/concluidos/CORR-WTE-052.md) | [WTE-TASK-22](/docs/tasks/concluidos/22-harness-golden.md) | O Log da WTE-TASK-22 diz 15 testes no `golden_veredito.py`, em dois sítios, e são 18 | Alta | [x] concluída | 2026-08-11 |
| [CORR-WTE-053](/docs/tasks/concluidos/CORR-WTE-053.md) | [WTE-TASK-22](/docs/tasks/concluidos/22-harness-golden.md) | A seção 2 descreve o controle como uma faixa de 11.952 bytes; o gate declara nove faixas e 11.955, e nenhum dos dois textos diz de qual imagem fala | Baixa | [x] concluída | 2026-08-11 |
| [CORR-WTE-054](/docs/tasks/concluidos/CORR-WTE-054.md) | [WTE-TASK-24](/docs/tasks/concluidos/24-ghidra-convencao-borland.md) | O `vmt.md` diz que todo número saiu do `vmt_probe.java`, e os votos da âncora (4 entre ~150) não têm ferramenta que os produza | Alta | [x] concluída | 2026-08-11 |
| [CORR-WTE-055](/docs/tasks/concluidos/CORR-WTE-055.md) | [WTE-TASK-24](/docs/tasks/concluidos/24-ghidra-convencao-borland.md) | A seção 4 do enunciado chama de 322 os imports de `rtl60`/`vcl60`; são 267, e o Log da própria task diz 267 | Baixa | [x] concluída | 2026-08-11 |
| [CORR-WTE-056](/docs/tasks/concluidos/CORR-WTE-056.md) | [WTE-TASK-24](/docs/tasks/concluidos/24-ghidra-convencao-borland.md) | O `borland_cc.md` e o `run_headless.sh` mandam rodar `apply_names.py`, e o script é `.java` | Baixa | [x] concluída | 2026-08-11 |
| [CORR-WTE-057](/docs/tasks/concluidos/CORR-WTE-057.md) | [WTE-TASK-25](/docs/tasks/concluidos/25-handlers-de-carga.md) | A conferência de tela mede 3 dos 5 grupos de campo que o critério enumera: o recorte de 520×240 exclui os 23 números de camisa e a lista de jogadores, e o estado de habilitação nunca foi confrontado | Alta | [x] concluída | 2026-08-11 |
| [CORR-WTE-058](/docs/tasks/concluidos/CORR-WTE-058.md) | [WTE-TASK-25](/docs/tasks/concluidos/25-handlers-de-carga.md) | O `visual.md` manda rodar o `capture_forms.sh`, removido nesta task, e a árvore do `progresso.md` não tem `src/impl/` nem as ferramentas novas | Baixa | [x] concluída | 2026-08-11 |
| [CORR-WTE-059](/docs/tasks/concluidos/CORR-WTE-059.md) | [WTE-TASK-25](/docs/tasks/concluidos/25-handlers-de-carga.md) | A spec do `lista_equiposChange` justifica o `aberto` com "ainda não conferido contra a tela", e a seção seguinte é a conferência de tela | Baixa | [x] concluída | 2026-08-11 |
| [CORR-WTE-060](/docs/tasks/concluidos/CORR-WTE-060.md) | [WTE-TASK-26](/docs/tasks/concluidos/26-handlers-de-edicao.md) | O `iguala_nombres` não acinzenta no port — 0 px de mudança contra 518 do oráculo —, e o defeito atravessou duas tasks sendo encaminhado para uma correção que ninguém abriu | Alta | [x] concluída | 2026-08-18 |
| [CORR-WTE-061](/docs/tasks/concluidos/CORR-WTE-061.md) | [WTE-TASK-26](/docs/tasks/concluidos/26-handlers-de-edicao.md) | O `MaxLength` de `edit_nombre1` é o literal 5, lido da tela; qual campo do formato tem 10 bytes continua sem medir | Baixa | [x] concluída | 2026-08-18 |
| [CORR-WTE-062](/docs/tasks/concluidos/CORR-WTE-062.md) | [WTE-TASK-25](/docs/tasks/concluidos/25-handlers-de-carga.md) | O `lista_formacionesClick` é do grupo `carga`, foi encaminhado para a 26 pelo efeito, e continua `REStub` com as duas tasks concluídas | Alta | [x] concluída | 2026-08-18 |
| [CORR-WTE-063](/docs/tasks/concluidos/CORR-WTE-063.md) | [WTE-TASK-26](/docs/tasks/concluidos/26-handlers-de-edicao.md) | As três carregadoras de bitmap da ficha não têm dono em nenhuma das 40 tasks, e a 32 não menciona cara, cabelo nem barba | Alta | [x] concluída | 2026-08-18 |
| [CORR-WTE-064](/docs/tasks/concluidos/CORR-WTE-064.md) | [WTE-TASK-26](/docs/tasks/concluidos/26-handlers-de-edicao.md) | O lote do `edit_nombre1` está provado e a travessia emulada dá 6 onde o oráculo corta em 5 | Média | [x] concluída | 2026-08-18 |
| [CORR-WTE-065](/docs/tasks/concluidos/CORR-WTE-065.md) | [WTE-TASK-33](/docs/tasks/concluidos/33-slots-de-master-league.md) | "o maior `b0` medido é 43" está em três sítios e a varredura das duas ROMs dá 111 e 116 | Alta | [x] concluída | 2026-08-19 |
| [CORR-WTE-066](/docs/tasks/concluidos/CORR-WTE-066.md) | [WTE-TASK-33](/docs/tasks/concluidos/33-slots-de-master-league.md) | A tabela de endereços atropelados lista o 462, que nunca é alcançado, e omite o `0x004335f4`, que é | Alta | [x] concluída | 2026-08-19 |
| [CORR-WTE-067](/docs/tasks/concluidos/CORR-WTE-067.md) | [WTE-TASK-33](/docs/tasks/concluidos/33-slots-de-master-league.md) | A nota nova da WTE-TASK-27 põe a `AtualizaBlocosLivresDeMl` no `we2002_ml` e promete um mapa de ocupação que a unidade não expõe | Baixa | [x] concluída | 2026-08-19 |
| [CORR-WTE-068](/docs/tasks/concluidos/CORR-WTE-068.md) | [WTE-TASK-27](/docs/tasks/concluidos/27-handlers-de-gravacao.md) | Três specs de gravação ainda dizem que o gate passa "só as duas faixas do arranque"; medido hoje, os três dão byte-idêntico | Alta | [x] concluída | 2026-08-20 |
| [CORR-WTE-069](/docs/tasks/concluidos/CORR-WTE-069.md) | [WTE-TASK-27](/docs/tasks/concluidos/27-handlers-de-gravacao.md) | As três funções novas do `we2002_ml` (`IndiceDoBlocoMl`, `ParDoIndiceLinearMl`, `PrimeiroBlocoLivreMl`) entraram no caminho de gravação sem um teste sequer | Baixa | [x] concluída | 2026-08-20 |
| [CORR-WTE-070](/docs/tasks/concluidos/CORR-WTE-070.md) | [WTE-TASK-27](/docs/tasks/concluidos/27-handlers-de-gravacao.md) | A tabela "Arquivos a criar ou modificar" da 27 aponta para `wte/tools/roteiros/gravacao-*.sh`, que não existe | Baixa | [x] concluída | 2026-08-20 |
| [CORR-WTE-071](/docs/tasks/concluidos/CORR-WTE-071.md) | [WTE-TASK-28](/docs/tasks/concluidos/28-import-de-mcr.md) | O mapa do `.mcr` afirma 16 destinos em cinco lugares; o `LAYOUT` do gerador tem 17, e o título gerado o diz logo acima da tabela com as 17 linhas | Alta | [x] concluída | 2026-08-20 |
| [CORR-WTE-072](/docs/tasks/concluidos/CORR-WTE-072.md) | [WTE-TASK-28](/docs/tasks/concluidos/28-import-de-mcr.md) | O `gravacao-controle.md` fecha dizendo que o `boton_mcr2isoClick` escreve setor inteiro — premissa que a WTE-TASK-28 mediu e refutou, e que o próprio doc já desmente 30 linhas acima | Alta | [x] concluída | 2026-08-20 |
| [CORR-WTE-073](/docs/tasks/concluidos/CORR-WTE-073.md) | [WTE-TASK-28](/docs/tasks/concluidos/28-import-de-mcr.md) | O `check_lcl_combo.py` ficou preso no `:99` em código vivo depois da mudança para o `:98`: pula em silêncio numa máquina só com o `:98` | Alta | [x] concluída | 2026-08-20 |
| [CORR-WTE-074](/docs/tasks/concluidos/CORR-WTE-074.md) | [WTE-TASK-28](/docs/tasks/concluidos/28-import-de-mcr.md) | A confrontação Pascal × Python do leitor de `.mcr` aponta para `work/saida.mcr`, que o `golden_check.sh` apaga a cada corrida; a fixture estável tem outro nome | Baixa | [x] concluída | 2026-08-20 |
| [CORR-WTE-075](/docs/tasks/concluidos/CORR-WTE-075.md) | [WTE-TASK-28](/docs/tasks/concluidos/28-import-de-mcr.md) | `do_roundtrip()` grava num destino fixo versionado, e o teste sobrescreve a medição de `wte/re/mcr-roundtrip.tsv` e a repõe num `finally` | Baixa | [x] concluída | 2026-08-20 |
| [CORR-WTE-076](/docs/tasks/concluidos/CORR-WTE-076.md) | [WTE-TASK-29](/docs/tasks/concluidos/29-camisa-e-bandeira-2d.md) | O plano e a task dizem que o `ficha_color` tem 758 linhas de DFM; o extrator versionado dá 866, e nunca deu 758 | Alta | [x] concluída | 2026-08-21 |
| [CORR-WTE-077](/docs/tasks/concluidos/CORR-WTE-077.md) | [WTE-TASK-29](/docs/tasks/concluidos/29-camisa-e-bandeira-2d.md) | A §5.3 do plano ainda descreve o render 2D como `TBitmap` + varredura de pixel, algoritmo que a WTE-TASK-29 mediu e refutou — é reescrita de paleta | Alta | [x] concluída | 2026-08-21 |
| [CORR-WTE-078](/docs/tasks/concluidos/CORR-WTE-078.md) | [WTE-TASK-29](/docs/tasks/concluidos/29-camisa-e-bandeira-2d.md) | O Log da sétima passagem conta 7 casos novos no `test_dump_zonas.py`; o commit acrescentou 9 | Baixa | [x] concluída | 2026-08-21 |
| [CORR-WTE-079](/docs/tasks/concluidos/CORR-WTE-079.md) | [WTE-TASK-29](/docs/tasks/concluidos/29-camisa-e-bandeira-2d.md) | O `compara_tela.sh` ficou com dois blocos de `--malha` mortos — um duplicado no `captura_oraculo` e um aninhado no ramo `cor|grade` do `captura_port`, com `continue` fora de laço | Baixa | [x] concluída | 2026-08-21 |
| [CORR-WTE-080](/docs/tasks/concluidos/CORR-WTE-080.md) | [WTE-TASK-29](/docs/tasks/concluidos/29-camisa-e-bandeira-2d.md) | O `golden-14-uniforme` falhou por espera de janela em 3 de 4 corridas do modo controle nesta revisão; a 4ª deu byte-idêntico | Alta | [x] concluída | 2026-08-21 |
| [CORR-WTE-081](/docs/tasks/concluidos/CORR-WTE-081.md) | [WTE-TASK-30](/docs/tasks/concluidos/30-handlers-auxiliares.md) | Três gravações na imagem sem dono — o `OK` do `ficha_color`, o `Comple.` do `jugador` e o ` Accept` do `estrategia`; a WTE-TASK-27 contava seis gravações e são nove | Alta | [x] concluída | 2026-08-21 |
| [CORR-WTE-082](/docs/tasks/concluidos/CORR-WTE-082.md) | [CORR-WTE-081](/docs/tasks/concluidos/CORR-WTE-081.md) | A tela de tática nunca é enchida — a `0x0040A0B4` (1.443 B) não tem port, e sem ela o ` Accept` do `estrategia` gravaria as coordenadas de tempo de projeto do `.lfm` | Alta | [x] concluída | 2026-08-21 |
| [CORR-WTE-083](/docs/tasks/concluidos/CORR-WTE-083.md) | [WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md) | Dez times desenham bandeira preta — os 8 CLASSIC e dois clubes de ML: o `ed.exe` não lê a paleta deles e o editor do Obocaman lê | Alta | [x] concluída | 2026-08-23 |
| [CORR-WTE-084](/docs/tasks/concluidos/CORR-WTE-084.md) | [CORR-WTE-083](/docs/tasks/concluidos/CORR-WTE-083.md) | O combo 85 (`ml_teams[22]`) diverge por POSIÇÃO depois de a paleta ser consertada — bandeira 2 px mais abaixo, e a barra `equipe` do oráculo em 76 px, fora da grade `11v+9` | Média | [x] concluída | 2026-08-23 |
| [CORR-WTE-085](/docs/tasks/concluidos/CORR-WTE-085.md) | [WTE-TASK-30](/docs/tasks/concluidos/30-handlers-auxiliares.md) | O plano e o `progresso.md` ainda dizem "duas das **seis** gravações" onde o `check_fase4.py` mede **dezessete**; o plano se contradiz a dezesseis linhas de distância | Alta | [x] concluída | 2026-08-23 |
| [CORR-WTE-086](/docs/tasks/concluidos/CORR-WTE-086.md) | [WTE-TASK-30](/docs/tasks/concluidos/30-handlers-auxiliares.md) | A WTE-TASK-30 dá o `pabajoClick` como dono da rota de vínculo do `ficha_enlaza`; nenhuma spec nem código liga os dois — quem abre o modal é o `mostrar_jugadorClick`, que segue `aberto` | Baixa | [x] concluída | 2026-08-23 |
| [CORR-WTE-087](/docs/tasks/concluidos/CORR-WTE-087.md) | [WTE-TASK-30](/docs/tasks/concluidos/30-handlers-auxiliares.md) | O Log da WTE-TASK-30 conta 12 `.inc` novos e 6 `.uses` tocados; o commit `fb640cd` tem 11 `.inc` novos e 5 `.uses` | Baixa | [x] concluída | 2026-08-23 |
| [CORR-WTE-088](/docs/tasks/concluidos/CORR-WTE-088.md) | [WTE-TASK-30](/docs/tasks/concluidos/30-handlers-auxiliares.md) | Nove comentários de ferramenta viva ainda descrevem o gate no `:99` depois da mudança para o `:98` — entre eles a lista de guardas do `golden_check.sh` | Baixa | [x] concluída | 2026-08-23 |
| [CORR-WTE-089](/docs/tasks/concluidos/CORR-WTE-089.md) | [WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md) | Três vereditos `aberto` por "nada exercita o corpo" quando a bateria golden já os exercita — o `lista_jugadores_1Change` dispara em quatro gates verdes | Alta | [x] concluída | 2026-08-24 |
| [CORR-WTE-090](/docs/tasks/concluidos/CORR-WTE-090.md) | [WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md) | Três vereditos `aberto` esperando decisão já tomada ou de outra fase; o `ComboBoxDrawItem` fechava o ciclo 31→37→34→31 | Alta | [x] concluída | 2026-08-24 |
| [CORR-WTE-091](/docs/tasks/concluidos/CORR-WTE-091.md) | [WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md) | O `Original ` da ficha não alcançava a `PreencheFicha` por ciclo de `uses`, e a régua dele precisa ser um par de roteiros que difere por um clique | Alta | [x] concluída | 2026-08-24 |
| [CORR-WTE-092](/docs/tasks/concluidos/CORR-WTE-092.md) | [WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md) | O ramo do reserva e o arrasto de bola não tinham estímulo; o harness não sabia produzir `mousedown` | Alta | [x] concluída | 2026-08-24 |
| [CORR-WTE-093](/docs/tasks/concluidos/CORR-WTE-093.md) | [WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md) | Os quatro laços do maior `FormCreate` não tinham leitura, e o dono do diálogo de textura (WTE-TASK-29) fechou sem ele | Alta | [x] concluída | 2026-08-24 |
| [CORR-WTE-094](/docs/tasks/concluidos/CORR-WTE-094.md) | [WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md) | A WTE-TASK-32 abre dizendo que o `ed.exe` não calcula preço; ele calcula, o que falta é o botão — e a fórmula dele já está transpilada nesta árvore | Média | [x] concluída | 2026-08-24 |
| [CORR-WTE-095](/docs/tasks/concluidos/CORR-WTE-095.md) | [WTE-TASK-32](/docs/tasks/concluidos/32-preco-do-jogador.md) | O editor do Obocaman nunca preça o slot 22 e o `ed.exe` diz que ele tem preço; medido em seis times, e o `je` da terceira coluna já foi descartado como causa | Média | [x] concluída | 2026-08-24 |
| [CORR-WTE-096](/docs/tasks/concluidos/CORR-WTE-096.md) | [WTE-TASK-32](/docs/tasks/concluidos/32-preco-do-jogador.md) | Chave duplicada no `GOLDEN_DE` do `check_fase4.py` apaga o gate do `base_teamClick`: o `fase-4.md` publica **nenhum** para o único escritor que tem golden verde | Alta | [x] concluída | 2026-08-24 |
| [CORR-WTE-097](/docs/tasks/concluidos/CORR-WTE-097.md) | [WTE-TASK-32](/docs/tasks/concluidos/32-preco-do-jogador.md) | O cabeçalho do `base_teamClick.inc` diz "medido em dois times" onde a amostra final tem seis, e é ali que mora o `ULTIMO_SLOT_PRECADO` | Baixa | [x] concluída | 2026-08-24 |
| [CORR-WTE-098](/docs/tasks/concluidos/CORR-WTE-098.md) | [WTE-TASK-32](/docs/tasks/concluidos/32-preco-do-jogador.md) | A §5.1 do plano ainda diz que o preço "não precisa de golden test de imagem" e nomeia só o `etiqprecioClick`; a outra metade grava e tem o `golden-22-precos` | Média | [x] concluída | 2026-08-24 |
| [CORR-WTE-099](/docs/tasks/concluidos/CORR-WTE-099.md) | [WTE-TASK-32](/docs/tasks/concluidos/32-preco-do-jogador.md) | A lista de arquivos da WTE-TASK-32 não menciona as quinze linhas acrescentadas ao `.gitignore` | Baixa | [x] concluída | 2026-08-24 |
| [CORR-WTE-100](/docs/tasks/concluidos/CORR-WTE-100.md) | [CORR-WTE-095](/docs/tasks/concluidos/CORR-WTE-095.md) | A citação `` `{$Q-}` `` num comentário do `we2002_preco.pas` abre nível 2: é o único warning do build, e em `{$mode delphi}` seria erro fatal | Baixa | [x] concluída | 2026-08-24 |
| [CORR-WTE-101](/docs/tasks/concluidos/CORR-WTE-101.md) | [WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md) | O contrato da spec diz "seis seções obrigatórias" e a ferramenta cobra cinco; e a frase do `fase-4.md` apresenta as 481 linhas de evidência como se fossem todas, quando 44 outras ficam fora da conta | Média | [x] concluída | 2026-08-24 |
| [CORR-WTE-102](/docs/tasks/concluidos/CORR-WTE-102.md) | [WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md) | Quatro sítios vivos ainda derivam as dezessete gravações "das 94 specs"; o índice conta 96 desde que a WTE-TASK-32 escreveu as duas de preço | Média | [x] concluída | 2026-08-24 |
| [CORR-WTE-103](/docs/tasks/concluidos/CORR-WTE-103.md) | [WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md) | No estado zero o `check_fase4.py` emite o título `## Os que continuam aberto` colado no parágrafo — a linha em branco mora dentro do `if` que lista os sem spec | Baixa | [x] concluída | 2026-08-24 |
| [CORR-WTE-104](/docs/tasks/concluidos/CORR-WTE-104.md) | [WTE-TASK-34](/docs/tasks/concluidos/34-bateria-golden-completa.md) | O `golden-24-gravacao-dupla` grava no time 2, cujos dois primeiros cobradores são iguais (`[7, 7, …]`): a troca do `Load`+`Save` que ele existe para medir é a identidade ali, e o roteiro passa com vaivém e sem ele | Alta | [x] concluída | 2026-08-25 |
| [CORR-WTE-105](/docs/tasks/concluidos/CORR-WTE-105.md) | [WTE-TASK-34](/docs/tasks/concluidos/34-bateria-golden-completa.md) | A pendência do vaivém dos cobradores foi encaminhada por prosa da WTE-TASK-34 para a 35, e a 35 não a tem em lugar nenhum — zero ocorrências no arquivo dela | Baixa | [x] concluída | 2026-08-25 |
| [CORR-WTE-106](/docs/tasks/concluidos/CORR-WTE-106.md) | [WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md) | O `check_divergencias.py` é a única guarda de recusa do repositório sem `test_*.py`; as "três recusas vistas" do critério não deixaram artefato — as quatro foram exercitadas nesta revisão e saem com código 2 | Média | [x] concluída | 2026-08-25 |
| [CORR-WTE-107](/docs/tasks/concluidos/CORR-WTE-107.md) | [WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md) | A lista de arquivos da WTE-TASK-35 nomeia oito dos nove do commit; falta justamente o repasse escrito na WTE-TASK-36 | Baixa | [x] concluída | 2026-08-25 |
| [CORR-WTE-108](/docs/tasks/concluidos/CORR-WTE-108.md) | [WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md) | A task deixa "o plano é o que falta conferir" sobre o vaivém, e o plano nunca afirmou aquilo — zero ocorrências de `idempot`/`cobrador`/`OFS_KICKER` | Baixa | [x] concluída | 2026-08-25 |
| [CORR-WTE-109](/docs/tasks/concluidos/CORR-WTE-109.md) | [WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md) | Quatro sítios do lado WTE dizem que "o editor original não é idempotente", e neste projeto "o original" é o `wte.exe` — a medição da CORR-WTE-104 cobre um caminho e não a afirmação inteira | Média | [x] concluída | 2026-08-25 |
| [CORR-WTE-110](/docs/tasks/concluidos/CORR-WTE-110.md) | [WTE-TASK-36](/docs/tasks/concluidos/36-buffers-e-truncamento.md) | Os quatro casos de borda foram medidos num vetor só (`names`, 20 B) e o critério diz "por campo"; `abbreviations` (4 B, a menor folga), `name` e `kanji_name` não passam pelos grupos 1 e 2 | Média | [x] concluída | 2026-08-25 |
| [CORR-WTE-111](/docs/tasks/concluidos/CORR-WTE-111.md) | [WTE-TASK-36](/docs/tasks/concluidos/36-buffers-e-truncamento.md) | A chave `faixa` do `CAMPOS` não é lida por ninguém, e dois dos quatro valores contradizem o medido — `edit_nombre1` declara (5,19) contra 5..13 | Baixa | [x] concluída | 2026-08-25 |
| [CORR-WTE-112](/docs/tasks/concluidos/CORR-WTE-112.md) | [WTE-TASK-36](/docs/tasks/concluidos/36-buffers-e-truncamento.md) | O `filtro` de caracteres é publicado por campo no `buffers.md` e nunca conferido contra o `KeyPress`, enquanto o `predicado` de faixa ao lado aborta se sumir | Baixa | [x] concluída | 2026-08-25 |
| [CORR-WTE-113](/docs/tasks/concluidos/CORR-WTE-113.md) | [WTE-TASK-37](/docs/tasks/concluidos/37-reconferencia-de-ui.md) | `golden_suite.sh --roteiro` sem `--retomar` trunca o `golden.tsv` inteiro antes de qualquer corrida — 97 linhas viram 1, e foi assim que as 92 corridas da WTE-TASK-34 se perderam | Alta | [x] concluída | 2026-08-25 |
| [CORR-WTE-114](/docs/tasks/concluidos/CORR-WTE-114.md) | [WTE-TASK-37](/docs/tasks/concluidos/37-reconferencia-de-ui.md) | As três divergências que a WTE-TASK-37 mediu foram parqueadas numa task já concluída; o `divergencias.md` não tem nenhuma, e uma delas se declara "ainda sem entrada aqui" | Média | [x] concluída | 2026-08-25 |
| [CORR-WTE-115](/docs/tasks/concluidos/CORR-WTE-115.md) | [WTE-TASK-37](/docs/tasks/concluidos/37-reconferencia-de-ui.md) | O `check_carregado.py` aborta na moldura e não tem `test_*.py`, enquanto o `check_retorno.py`, nascido no mesmo commit, tem | Baixa | [x] concluída | 2026-08-25 |
| [CORR-WTE-116](/docs/tasks/concluidos/CORR-WTE-116.md) | [WTE-TASK-38](/docs/tasks/concluidos/38-nome-e-linhagem.md) | O controle que separa a causa do diálogo da LCL manda `mkdir re` "ao lado da cópia", e ali não funciona: o `retrace.pas` resolve `<dir do executável>/../re/` — medido nos três layouts | Baixa | [x] concluída | 2026-08-25 |
| [CORR-WTE-117](/docs/tasks/concluidos/CORR-WTE-117.md) | [WTE-TASK-39](/docs/tasks/concluidos/39-empacotamento.md) | O `RaizDosAssets` procura em quatro lugares e a `MensagemDeAssetsAusentes` promete três; o quarto (`<exe>/../../assets`) não tem comentário nem quem o crie | Média | [x] concluída | 2026-08-26 |
| [CORR-WTE-118](/docs/tasks/concluidos/CORR-WTE-118.md) | [WTE-TASK-39](/docs/tasks/concluidos/39-empacotamento.md) | A seção de repasse da WTE-TASK-39 ainda manda renomear `wte.lpi`/`wte.lpr`/`build/wte`, e o Log da mesma task revogou a instrução — a seção não foi anotada | Baixa | [x] concluída | 2026-08-26 |
| [CORR-WTE-119](/docs/tasks/concluidos/CORR-WTE-119.md) | [WTE-TASK-40](/docs/tasks/concluidos/40-verificacao-final.md) | O `nativo.md` repete os sete valores do `nativo.tsv` e nada confere os dois — a condição 3 é o único documento de fechamento sem `--check` nem conferidor | Média | [x] concluída | 2026-08-26 |
| [CORR-WTE-120](/docs/tasks/concluidos/CORR-WTE-120.md) | [WTE-TASK-40](/docs/tasks/concluidos/40-verificacao-final.md) | A prosa credita a recusa do `sem_wine.sh` ao `command -v wine*`, que nesta máquina não pode disparar; quem recusa é o laço que exige alvo vazio | Baixa | [x] concluída | 2026-08-26 |
| [CORR-WTE-121](/docs/tasks/concluidos/CORR-WTE-121.md) | [WTE-TASK-34](/docs/tasks/concluidos/34-bateria-golden-completa.md) | O port grava 3 faixas de nome de time diferentes do oráculo; `golden-05-nomes` e `golden-23-multiplas-edicoes` reprovam na `ptbr-remaster`, a única ROM com oráculo vivo **e** nomes latinos | Alta | [x] concluída | 2026-08-28 |
| [CORR-WTE-122](/docs/tasks/concluidos/CORR-WTE-122.md) | [PAR-TASK-01](/docs/tasks/concluidos/PAR-TASK-01.md) | O `progresso.md` chama a régua desta série de "`golden_gui` com `GOLDEN_EDIT`"; o `golden_gui.sh` lê `GOLDEN_GUI_EDIT`, e a própria PAR-TASK-01 corrigiu esse nome no arquivo dela e deixou no `progresso.md` | Média | [x] concluída | 2026-08-28 |
| [CORR-WTE-123](/docs/tasks/concluidos/CORR-WTE-123.md) | [PAR-TASK-01](/docs/tasks/concluidos/PAR-TASK-01.md) | Os seis roteiros das seis corridas golden não estão versionados em lugar nenhum, e a "Definição de pronto" marca "cada item com evidência: **o comando**" — as seis corridas verdes não são repetíveis | Alta | [x] concluída | 2026-08-28 |
| [CORR-WTE-124](/docs/tasks/concluidos/CORR-WTE-124.md) | [PAR-TASK-02](/docs/tasks/concluidos/PAR-TASK-02.md) | `CMD_DEFAULT_NUMBERS` grava 37 faixas no port contra 20 no `ed.exe`; 18 divergências fora da faixa conhecida, reprodutíveis sem seleção de time | Alta | [x] concluída | 2026-08-29 |
| [CORR-WTE-125](/docs/tasks/concluidos/CORR-WTE-125.md) | [PAR-TASK-03](/docs/tasks/concluidos/PAR-TASK-03.md) | `Escape` depois de navegar um combo de cobrador grava no `ed.exe` e não no port; a §3.5 afirma o contrário do medido | Alta | [x] concluída | 2026-08-29 |
| [CORR-WTE-126](/docs/tasks/concluidos/CORR-WTE-126.md) | [PAR-TASK-02](/docs/tasks/concluidos/PAR-TASK-02.md) | Os itens 1 e 2 da §8.2 não têm roteiro em `tools/par/` e a "Definição de pronto" marca "cada item com evidência: **o comando**"; a §8.2 é a única seção fora da convenção que a CORR-WTE-123 fixou um dia antes | Alta | [x] concluída | 2026-08-29 |
| [CORR-WTE-127](/docs/tasks/concluidos/CORR-WTE-127.md) | [PAR-TASK-03](/docs/tasks/concluidos/PAR-TASK-03.md) | O conserto do `Escape` da CORR-WTE-125 não alcança os dez combos de papel, que gravam pelo **mesmo** `FocusOut`; medido: três `Down` e `Escape` num combo de papel reprovam o golden em `OFS_FORMATIONS+0` | Alta | [x] concluída | 2026-08-29 |
| [CORR-WTE-128](/docs/tasks/concluidos/CORR-WTE-128.md) | [PAR-TASK-04](/docs/tasks/concluidos/PAR-TASK-04.md) | O item 1 da §8.4 (clamp de habilidade) não tem roteiro em `tools/par/`, e a seção afirma "Roteiros em `tools/par/8.4-*.sh`" para os cinco — o quinto arquivo é o prelúdio, que não roda sozinho | Alta | [x] concluída | 2026-08-29 |
| [CORR-WTE-129](/docs/tasks/concluidos/CORR-WTE-129.md) | [PAR-TASK-04](/docs/tasks/concluidos/PAR-TASK-04.md) | O Log da PAR-TASK-04 põe o `CMD_SKILLS1` em dlu (392,36) na seção escrita para quem retomar; o `controls.json`, a §8.4 e o `8.4-prelude.sh` dizem (382,32) | Baixa | [x] concluída | 2026-08-29 |
| [CORR-WTE-130](/docs/tasks/concluidos/CORR-WTE-130.md) | [PAR-TASK-05](/docs/tasks/concluidos/PAR-TASK-05.md) | O cabeçalho do `8.5-selecao-nacional.sh` diz que a caixa desmarcada é a substituição completa; é o contrário, e `PAR_INCOMPLETE=1` roda a **completa** | Média | [x] concluída | 2026-08-29 |
| [CORR-WTE-131](/docs/tasks/concluidos/CORR-WTE-131.md) | [PAR-TASK-06](/docs/tasks/concluidos/PAR-TASK-06.md) | As edições do `DefaultTacticsDialog` não chegam ao disco no port e chegam no `ed.exe`; o `IDOK` é `NOT WS_VISIBLE` e no Qt isso deixa o diálogo sem caminho de confirmação | Alta | [x] concluída | 2026-08-30 |
| [CORR-WTE-132](/docs/tasks/concluidos/CORR-WTE-132.md) | [PAR-TASK-06](/docs/tasks/concluidos/PAR-TASK-06.md) | Diagnóstico invertido: os 52 bytes do port é que estão certos (`tattDlg.cpp:701` valida 52); quem exporta errado é o `ed.exe` x64. Fechada sem mudar código | Alta | [x] concluída | 2026-09-01 |
| [CORR-WTE-133](/docs/tasks/concluidos/CORR-WTE-133.md) | [PAR-TASK-08](/docs/tasks/concluidos/PAR-TASK-08.md) | Os dois lados liam `defaultlook.txt` diferentes — o legado abre por caminho relativo e lê a cópia gitignored de `Debug/`. Sem mudança de código | Média | [x] concluída | 2026-09-01 |
| [CORR-WTE-134](/docs/tasks/concluidos/CORR-WTE-134.md) | [PAR-TASK-06](/docs/tasks/concluidos/PAR-TASK-06.md) | O `Escape` depois de navegar um dos dez combos de papel do `DefaultTacticsDialog` não grava no port e grava no `ed.exe` — a CORR-WTE-127 só alcançou os dezesseis do `MainWindow` | Alta | [x] concluída | 2026-08-31 |
| [CORR-WTE-135](/docs/tasks/concluidos/CORR-WTE-135.md) | [PAR-TASK-06](/docs/tasks/concluidos/PAR-TASK-06.md) | O item 5 da §8.7 (o `.t2002`) foi fechado sem veredito de `golden_compare.py`; a perna "importar de volta" só existe como comentário dentro do roteiro | Alta | [x] concluída | 2026-08-31 |
| [CORR-WTE-136](/docs/tasks/concluidos/CORR-WTE-136.md) | [PAR-TASK-06](/docs/tasks/concluidos/PAR-TASK-06.md) | A §8.7 diz "seis roteiros em `tools/par/8.7-*.sh`" onde há oito, e o Log chama de "6º da lista" o item que é o 3º | Baixa | [x] concluída | 2026-08-31 |
| [CORR-WTE-137](/docs/tasks/concluidos/CORR-WTE-137.md) | [PAR-TASK-07](/docs/tasks/concluidos/PAR-TASK-07.md) | `8.8-b2002-exportar.sh` não reproduz (4 corridas, 4 resultados), não confere que o arquivo saiu, e deixa o `FlagKitDialog` modal aberto — o harness diz `gravado` com a imagem `IDENTICAL` | Alta | [x] concluída | 2026-08-31 |
| [CORR-WTE-138](/docs/tasks/concluidos/CORR-WTE-138.md) | [PAR-TASK-07](/docs/tasks/concluidos/PAR-TASK-07.md) | Os ids 69 e 86 do item 2 da §8.8 estão marcados `[x]` sem evidência; são os dois de Master League, abertos pelo outro ramo do `OnButtgraf` | Baixa | [x] concluída | 2026-08-31 |
| [CORR-WTE-139](/docs/tasks/concluidos/CORR-WTE-139.md) | [CORR-WTE-135](/docs/tasks/concluidos/CORR-WTE-135.md) | `Return` depois de clicar `CMD_IMP`/`CMD_EXP` reabre o botão no port e fecha o diálogo no `ed.exe`: o `QPushButton` focado consome a tecla antes do `keyPressEvent`, e o diálogo fica sem saída pelo teclado | Média | [x] concluída | 2026-08-31 |
| [CORR-WTE-140](/docs/tasks/concluidos/CORR-WTE-140.md) | [PAR-TASK-09](/docs/tasks/concluidos/PAR-TASK-09.md) | Cancelar o diálogo de abertura encerra o port e deixa o `ed.exe` com o diálogo principal vazio: `return FALSE` no `OnInitDialog` não fecha diálogo em MFC, e o comentário do `main.cpp` afirma que fecha | Média | [x] concluída | 2026-08-31 |
| [CORR-WTE-141](/docs/tasks/concluidos/CORR-WTE-141.md) | [PAR-TASK-09](/docs/tasks/concluidos/PAR-TASK-09.md) | `Return` na janela principal encerra o `ed.exe` (`CDialog::OnOK`, sem `DEFPUSHBUTTON`) e não faz nada no port; nenhum dos dois dispara edição, o ciclo de vida é que diverge | Média | [x] concluída | 2026-08-31 |
| [CORR-WTE-142](/docs/tasks/concluidos/CORR-WTE-142.md) | [PAR-TASK-09](/docs/tasks/concluidos/PAR-TASK-09.md) | Os roteiros de ciclo de vida gravam captura em `/tmp/c09`, que nenhum deles cria — nenhuma imagem é produzida, e o do oráculo imprime "captura em ..." mesmo assim | Alta | [x] concluída | 2026-08-31 |
| [CORR-WTE-143](/docs/tasks/concluidos/CORR-WTE-143.md) | [PAR-TASK-09](/docs/tasks/concluidos/PAR-TASK-09.md) | `8.10-return-nao-dispara.sh` é classificado como hook de golden, mas com `GOLDEN_EDIT` o oráculo encerra e o `golden_check.sh` reprova por construção; o cabeçalho não avisa | Baixa | [x] concluída | 2026-08-31 |
...
- [x] CORR-WTE-137 — fechar o modal, esperar o arquivo e falhar alto no roteiro de export da §8.8
...
- [x] CORR-WTE-143 — dizer no cabeçalho que o roteiro do item 4 é hook de um lado só
...
- **Arquivo com problema:** `docs/tasks/concluidos/29-camisa-e-bandeira-2d.md` ou
  `docs/tasks/concluidos/35-divergencias-deliberadas.md`, conforme a decisão
...
- **Arquivo com problema:** `docs/tasks/concluidos/01-ferramental.md` (frontmatter), com a
...
- **Arquivo com problema:** `docs/tasks/concluidos/25-handlers-de-carga.md`,
  `docs/tasks/concluidos/30-handlers-auxiliares.md`, `docs/tasks/concluidos/32-preco-do-jogador.md`,
  `docs/PLAN-WTE-LAZARUS.md` (§5.1), `docs/tasks/concluidos/04-mapa-de-handlers.md`,
...
- **Arquivo com problema:** `docs/PLAN-WTE-LAZARUS.md` (§8.7) e
  `docs/tasks/concluidos/06-mapa-de-offsets.md` (enunciado, linha 45)
...
- **Arquivo com problema:** `docs/PLAN-WTE-LAZARUS.md` (§1.2 linha 117, §1.6
  linha 251) e `docs/tasks/concluidos/09-fechamento-fase-1.md` (quadro de reconciliação)
...
- **Arquivo com problema:** `docs/tasks/concluidos/09-fechamento-fase-1.md` (quadro de
...
- **Arquivo com problema:** `docs/PLAN-WTE-LAZARUS.md` §2, `.gitignore` (bloco
  `wte/re/dfm/blobs/`) e `docs/tasks/concluidos/progresso.md` ("Pendências externas")
...
- **Como foi detectado:** `git ls-files wte/forms/*.lfm` (18 rastreados,
  ...
  .gitignore` e `sed -n '305,306p' docs/tasks/concluidos/progresso.md`
...
- **Arquivo com problema:** `docs/tasks/concluidos/10-conversor-dfm-para-lfm.md` (critério
  dos blobs) e `docs/tasks/concluidos/12-comparacao-visual.md`
...
- **Arquivo com problema:** `wte/src/wtemain.pas` (cabeçalho, linhas 21-22) e
  `docs/tasks/concluidos/11-app-com-a-casca-completa.md` (Log, linhas 115-118) — o mesmo
  comando nos dois
...
- **Arquivo com problema:** `docs/tasks/concluidos/11-app-com-a-casca-completa.md`,
...
- **Escrito no critério: 2.567.** As 2.562 acima valiam quando esta correção
  foi aberta; a [CORR-WTE-022](/docs/tasks/concluidos/CORR-WTE-022.md), executada no mesmo
  lote e antes desta, acrescentou 5 linhas ao cabeçalho de `wtemain.pas` —
  comentário conta em `lines compiled`

### CORR-WTE-024

- **Arquivo com problema:** `docs/tasks/concluidos/35-divergencias-deliberadas.md`,
  `docs/tasks/concluidos/12-comparacao-visual.md` e `docs/tasks/concluidos/25-handlers-de-carga.md`
...
- **Arquivo com problema:** `wte/re/visual.md:98`,
  `docs/tasks/concluidos/12-comparacao-visual.md:151` e
  `docs/tasks/concluidos/22-harness-golden.md:100,145`
...
- **Arquivo com problema:** `wte/re/eventos.md`, achado 2 (tabela nas linhas
  ...
  `docs/tasks/concluidos/13-trace-de-eventos.md`
...
- **Sintoma:** seis links para `docs/` na forma `/docs/tasks/...`, que
  ...
  [CORR-WTE-007](/docs/tasks/concluidos/CORR-WTE-007.md)
...
- **Arquivo com problema:** `docs/tasks/concluidos/16-gerador-de-tabelas.md`, o Log de
...
- **Arquivo com problema:** `docs/tasks/concluidos/17-transpilador-da-camada-de-dados.md`
...
- **Arquivo com problema:** `docs/tasks/concluidos/18-camada-de-dados-gerada.md` (Log de
...
- **Arquivo com problema:** `docs/tasks/concluidos/20-round-trip-headless.md:25-38`
...
- **Arquivo com problema:** `docs/tasks/concluidos/22-harness-golden.md`, linhas 225 e 236
...
- **Arquivo com problema:** `docs/tasks/concluidos/22-harness-golden.md`, seção 2
...
- **Arquivo com problema:** `docs/tasks/concluidos/24-ghidra-convencao-borland.md`, seção 4
...
- **Arquivo com problema:** `wte/re/visual.md` (linhas 12, 19 e 293) e a árvore
  de pastas do `docs/tasks/concluidos/progresso.md`
...
- **Arquivo com problema:** `wte/tools/conta_ml.py:185`,
  `wte/src/we2002_ml.pas:129`, `docs/tasks/concluidos/33-slots-de-master-league.md:179`
...
- **Arquivo com problema:** `docs/tasks/concluidos/27-handlers-de-gravacao.md`,
  linhas 178-181
...
- **Arquivo com problema:** `docs/tasks/concluidos/27-handlers-de-gravacao.md`, tabela
...
- **Arquivo com problema:** `wte/tools/dump_mcr.py` (linhas 30 e 528),
  `wte/re/mcr.md`, `wte/src/we2002_mcr.pas`, `docs/tasks/concluidos/28-import-de-mcr.md`
...
- **Arquivo com problema:** `docs/tasks/concluidos/29-camisa-e-bandeira-2d.md`, Log da
  sétima passagem
...
- **Sintoma:** depois de a [CORR-WTE-083](/docs/tasks/concluidos/CORR-WTE-083.md) dar cor
...
- **Arquivo com problema:** `docs/PLAN-WTE-LAZARUS.md:945` e `docs/tasks/concluidos/progresso.md:122`
...
- **Como foi detectado:** `grep -n "seis gravações" docs/PLAN-WTE-LAZARUS.md
  docs/tasks/concluidos/progresso.md` contra o `São **17**` do `wte/re/fase-4.md`, que é
...
- **Arquivo com problema:** `docs/tasks/concluidos/30-handlers-auxiliares.md`, seção
...
- **Arquivo com problema:** `docs/tasks/concluidos/30-handlers-auxiliares.md`, lista de
...
- **Arquivo com problema:** `docs/tasks/concluidos/32-preco-do-jogador.md`
...
- **Arquivo com problema:** `docs/tasks/concluidos/32-preco-do-jogador.md`, lista de
  arquivos
...
> [CORR-WTE-100](/docs/tasks/concluidos/CORR-WTE-100.md).
...
- **Arquivo com problema:** `docs/PLAN-WTE-LAZARUS.md:943`,
  `docs/tasks/concluidos/progresso.md:445`, `wte/tools/check_fase4.py:28` e `:95`
...
- **Arquivo com problema:** `docs/tasks/concluidos/35-divergencias-deliberadas.md`, lista
  de arquivos
- **Sintoma:** o commit `2e70784` tocou nove arquivos e a lista nomeia oito. O
  que falta é `docs/tasks/concluidos/36-buffers-e-truncamento.md`, o **repasse** — o único
...
- **Arquivo com problema:** `docs/tasks/concluidos/35-divergencias-deliberadas.md`, linha 260
...
- **Arquivo com problema:** `wte/re/divergencias.md` (ausências) e
  `docs/tasks/concluidos/35-divergencias-deliberadas.md` (onde as três foram parar)
...
- **Arquivo com problema:** `docs/tasks/concluidos/38-nome-e-linhagem.md` (linha 154),
...
- **Arquivo com problema:** `docs/tasks/concluidos/39-empacotamento.md`, seção
...
- **Arquivo com problema:** `docs/tasks/concluidos/progresso.md` (linha 1267)
- **Sintoma:** a frase que abre a série `PAR-TASK-*` atribui `GOLDEN_EDIT` ao
  `golden_gui`. Exportar só essa variável em modo `gui` edita o oráculo e não
  edita o port, e **toda faixa editada diverge** — falso vermelho com cara de
  bug do port
- **Como foi detectado:** `grep -rn "GOLDEN_GUI_EDIT\|GOLDEN_EDIT" tools/`
  (o `golden_gui.sh` lê `GOLDEN_GUI_EDIT` nas linhas 112-114) contra
  `sed -n '1267p' docs/tasks/concluidos/progresso.md`; a PAR-TASK-01 já registra o mesmo
  achado no Log e corrigiu apenas o arquivo dela
- **Fix:** nomear os dois hooks com o script que lê cada um, e dizer que o
  mesmo trecho de shell serve aos dois

### CORR-WTE-123

- **Arquivo com problema:** ausência de `tools/par/`; `docs/tasks/concluidos/PAR-TASK-01.md`
  e `docs/PARIDADE-FUNCIONAL.md` §8.1
- **Sintoma:** a §8.1 registra faixa e veredito dos cinco itens, mas nenhum dos
  seis roteiros que produziram os estímulos existe no repositório — o commit de
  fechamento (`b5997b7`) tocou três markdowns e nada em `tools/`. As corridas
  não são repetíveis, e a PAR-TASK-10 é o mesmo trabalho na outra plataforma
- **Como foi detectado:** `git show --stat b5997b7` e
  `grep -rn "GOLDEN_GUI_EDIT" docs/`; esta revisão teve de **reconstruir** o
  roteiro do item 1 para poder medir, e a reconstrução exigiu um fato que o Log
  não registra — o `Return` que confirma o popup do `CMB_TEAM`. Com ele,
  `golden_check.sh` deu `OK: identico ao oraculo, exceto o slot 64 conhecido` e
...
- **Arquivo com problema:** ausência de `tools/par/8.2-clamp-selecao.sh` e
  ...
  `docs/tasks/concluidos/PAR-TASK-02.md`
...
- **Arquivo com problema:** `src/app/MainWindow.cpp` (o `eventFilter`), mais a
  §8.7 do `docs/PARIDADE-FUNCIONAL.md` e a `docs/tasks/concluidos/PAR-TASK-06.md`
...
- **Arquivo com problema:** `docs/tasks/concluidos/PAR-TASK-04.md`, na seção "O que se
...
- **Arquivo com problema:** `tools/par/8.5-selecao-nacional.sh` (cabeçalho e o
  ...
  `docs/tasks/concluidos/PAR-TASK-05.md`
...
- **Arquivo com problema:** `docs/PARIDADE-FUNCIONAL.md` §8.7 item 5 e
  `docs/tasks/concluidos/PAR-TASK-06.md`
...
- **Arquivo com problema:** `docs/PARIDADE-FUNCIONAL.md` §8.7 (frase de
  abertura) e `docs/tasks/concluidos/PAR-TASK-06.md` (Log da quarta passagem)
...
- **Arquivo com problema:** `docs/PARIDADE-FUNCIONAL.md` §8.8 item 2 e
  `docs/tasks/concluidos/PAR-TASK-07.md`
