...
Na conferência de tela da [WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md)
...
- [x] `compara_tela.sh` verde nos **nove alcançáveis** — os sete CLASSIC
      ...
      [CORR-WTE-084](/docs/tasks/concluidos/CORR-WTE-084.md) mostrou que o desvio dele era
...
[CORR-WTE-084](/docs/tasks/concluidos/CORR-WTE-084.md). Em **2026-08-23** aquela correção
...
- criados: `docs/tasks/concluidos/CORR-WTE-084.md`
