...
| `docs/tasks/concluidos/15-mapeamento-de-tipo.md` | modificar (achado na varredura) |
...
`docs/tasks/concluidos/15-mapeamento-de-tipo.md:120` repete "38 `strcpy` e 10 `strcat`" na
