...
A [CORR-WTE-081](/docs/tasks/concluidos/CORR-WTE-081.md) fechou duas das três gravações
...
que a [WTE-TASK-22](/docs/tasks/concluidos/22-harness-golden.md) existe para permitir.
...
- modificados: `wte/re/spec/estrategia.BitBtn3Click.md` (a seção *Bytes
  tocados* e a justificativa), `docs/tasks/concluidos/CORR-WTE-081.md` (a linha que dizia
...
- reconciliação de doc, em commit próprio: `wte/tools/dump_zonas.py` e
  `wte/re/zonas.md`, `wte/re/formacoes.md`, `docs/tasks/concluidos/progresso.md`
