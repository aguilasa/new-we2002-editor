...
O critério de tela da [WTE-TASK-25](/docs/tasks/concluidos/25-handlers-de-carga.md) foi
...
- `wte/re/spec/MainForm.lista_equiposChange.md` — Saída para
  ...
  defeitos novos
- `docs/tasks/concluidos/25-handlers-de-carga.md` — o critério de tela diz o que passou a
