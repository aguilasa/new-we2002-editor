...
A [WTE-TASK-34](/docs/tasks/concluidos/34-bateria-golden-completa.md) fecha com uma
pendência nomeada, na seção *"O que ficou pendente"*:

> **O vaivém dos cobradores não foi provado, só coberto.** Encaminhado para a
> [WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md), que é quem registra
...
a [CORR-WTE-081](/docs/tasks/concluidos/CORR-WTE-081.md) pagou para descobrir na
...
[WTE-TASK-31](/docs/tasks/concluidos/31-fechamento-fase-4.md) batizou de **prosa vencida**:
...
>   (ver a [CORR-WTE-104](/docs/tasks/concluidos/CORR-WTE-104.md), que é pré-requisito:
...
([CORR-WTE-086](/docs/tasks/concluidos/CORR-WTE-086.md) foi a primeira, com o dono errado).
...
- [x] `grep -c "cobrador" docs/tasks/concluidos/35-divergencias-deliberadas.md` maior que
      zero — são **5**
...
[CORR-WTE-104](/docs/tasks/concluidos/CORR-WTE-104.md) como **pré-requisito** da medição.
...
- `docs/tasks/concluidos/35-divergencias-deliberadas.md` — a entrada
