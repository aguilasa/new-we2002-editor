...
### Arquivo: `docs/tasks/concluidos/36-buffers-e-truncamento.md` *(se a primeira não valer)*
...
| `docs/tasks/concluidos/36-buffers-e-truncamento.md` | modificar |
...
- `docs/tasks/concluidos/36-buffers-e-truncamento.md` — o critério
- `docs/tasks/concluidos/progresso.md`, `docs/PLAN-WTE-LAZARUS.md` — a varredura
