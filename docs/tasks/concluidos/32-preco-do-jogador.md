...
> ([CORR-WTE-094](/docs/tasks/concluidos/CORR-WTE-094.md), 2026-08-24). Ele calcula: a
...
> [WTE-TASK-30](/docs/tasks/concluidos/30-handlers-auxiliares.md) mediu a outra metade em
...
- [x] 100% de acerto sobre amostra grande — **das duas ROMs não**, e a razão é
      ...
      ([CORR-WTE-044](/docs/tasks/concluidos/CORR-WTE-044.md)). É a mesma adaptação que a
...
- **O que se aprendeu, e vale para as próximas:**
  ...
  **2. O original preça 22 slots, não 23** — achado que ninguém procurava. O
  ...
  [CORR-WTE-095](/docs/tasks/concluidos/CORR-WTE-095.md) **refutou isso em 2026-08-24**,
  ...
  **20**, o preço previsto para este slot — e o arquivo recebe **22** `write`.
  ...
  [WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md). Três coisas mais
  ficaram fechadas: o
...
- **Arquivos criados/modificados:**
  ...
  - criados: `wte/src/we2002_preco.pas`, `wte/tests/test_preco.pas`,
    ...
    `docs/tasks/concluidos/CORR-WTE-095.md`
  - modificados: `wte/src/impl/ep2002_mainform.base_teamClick.inc` (o miolo),
    ...
    `docs/tasks/concluidos/progresso.md`, `docs/tasks/concluidos/correcoes-progresso.md`,
