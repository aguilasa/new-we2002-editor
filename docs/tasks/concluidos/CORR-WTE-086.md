...
A [WTE-TASK-30](/docs/tasks/concluidos/30-handlers-auxiliares.md), na seção viva
...
- [x] `grep -n "pabajoClick" docs/tasks/concluidos/30-handlers-auxiliares.md` devolve uma
...
| Arquivo | Ação |
|---|---|
| `docs/tasks/concluidos/30-handlers-auxiliares.md` | modificado — a seção *"E a resposta dos dois é a mesma, medida"* |
