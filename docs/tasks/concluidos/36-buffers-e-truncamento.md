...
> **Entrada aberta pela [WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md)
...
- [x] Os quatro casos de borda testados por campo — em
      ...
      como esta linha diz. A [CORR-WTE-110](/docs/tasks/concluidos/CORR-WTE-110.md)
...
- **Arquivos criados/modificados:** ver `git show --stat`. Criados:
  ...
  `docs/PLAN-WTE-LAZARUS.md`, `docs/tasks/concluidos/progresso.md`; este arquivo.
