...
- [ ] Blobs binários preservados e visíveis na janela — **preservados**: os 118
      ...
      **Visíveis** é da [WTE-TASK-12](/docs/tasks/concluidos/12-comparacao-visual.md), que
...
- **Problemas encontrados:**
  ...
  5. **Os `.lfm` versionados somam 1,9 MiB, dos quais ~1,6 MiB são o hex dos
     ...
     *Resolvido:* o usuário confirmou versionar em 2026-08-06, e a exceção
     ...
     [`progresso.md`](/docs/tasks/concluidos/progresso.md) — pela
     [CORR-WTE-019](/docs/tasks/concluidos/CORR-WTE-019.md). A §2 deixa de tensionar.
