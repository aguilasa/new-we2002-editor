...
- **Arquivos criados/modificados:**
  ...
  - `docs/tasks/concluidos/18-camada-de-dados-gerada.md` — o passe estrutural entrou no
...
- **Problemas encontrados:**
  ...
  4. **`Team.hpp` e `Team.cpp` ficaram fora do `UNITS`, e nenhum gate acusou.**
     Achado da [CORR-WTE-034](/docs/tasks/concluidos/CORR-WTE-034.md), consequência 2. Os
