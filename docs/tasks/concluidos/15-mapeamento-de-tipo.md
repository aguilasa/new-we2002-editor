...
- [x] Cada decisão com o teste que a prova nomeado *(a decisão 5 ficou sem o
      ...
      [CORR-WTE-035](/docs/tasks/concluidos/CORR-WTE-035.md))*
...
- **Resumo do que foi feito:**
  ...
  **2.504 linhas** medidas. *(Escrito na execução como "~2.150 linhas", que era a
  ...
  declarados; corrigido pela [CORR-WTE-034](/docs/tasks/concluidos/CORR-WTE-034.md).)*
...
- **Arquivos criados/modificados:**
  ...
  | `docs/tasks/concluidos/15-mapeamento-de-tipo.md` | modificar — Log |
