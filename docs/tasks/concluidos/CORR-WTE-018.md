...
que a [CORR-WTE-006](/docs/tasks/concluidos/CORR-WTE-006.md) descreveu quando o mesmo
...
afirmado em prosa. A [CORR-WTE-016](/docs/tasks/concluidos/CORR-WTE-016.md) alargou o
...
- `docs/tasks/concluidos/progresso.md` (descrição do perímetro — discrepância achada no
