...
A [CORR-WTE-083](/docs/tasks/concluidos/CORR-WTE-083.md) deu cor às dez paletas de
...
| `docs/tasks/concluidos/35-divergencias-deliberadas.md` | modificar, se a barra for do oráculo |
...
2. **Nada a registrar na
   [WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md).** O passo 1 previa
