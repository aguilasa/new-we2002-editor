...
| `wte/src/impl/ep2002_color.*.inc`, `ep2002_mainform.colorearClick.inc` | criar — feito (os 11 de edição, mais o `FormCreate`, o `botonClick` e o `aux.inc`; os 4 restantes do formulário são da [WTE-TASK-30](/docs/tasks/concluidos/30-handlers-auxiliares.md)) |
...
- [x] **Determinado se `grabar_camisetaClick` escreve setor inteiro ou só
      ...
      [WTE-TASK-28](/docs/tasks/concluidos/28-import-de-mcr.md). Medido pelo
      `dump_render2d.py`, que recusa se os três `push` mudarem
- [x] **Bandeira e uniforme conferidos na tela contra o original, para os
      mesmos 3 times da [WTE-TASK-25](/docs/tasks/concluidos/25-handlers-de-carga.md)** —
...
- [x] **Os 11 handlers de edição do `ficha_color`, com spec cada** — entraram na
      ...
      da [WTE-TASK-30](/docs/tasks/concluidos/30-handlers-auxiliares.md) pela tabela "o que
...
- **A divergência deliberada da passagem anterior fica, e agora com a metade
  ...
  para a [WTE-TASK-35](/docs/tasks/concluidos/35-divergencias-deliberadas.md), junto com a
  primeira.
...
- **O que ficou pendente, e é de outro formulário:** os dois `malla`
  ...
  [WTE-TASK-30](/docs/tasks/concluidos/30-handlers-auxiliares.md) nomeia exatamente os 11
