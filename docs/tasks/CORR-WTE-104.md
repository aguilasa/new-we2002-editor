...
O terceiro critério da [WTE-TASK-34](/docs/tasks/34-bateria-golden-completa.md)
...
[WTE-TASK-35](/docs/tasks/35-divergencias-deliberadas.md). Rodado nesta
...
- **imagens diferentes** → há vaivém, e ele já está reproduzido (o par golden
  ...
  [WTE-TASK-35](/docs/tasks/35-divergencias-deliberadas.md) com o offset medido.
