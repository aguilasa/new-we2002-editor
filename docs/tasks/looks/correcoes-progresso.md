...
| [CORR-LOOKS-071](/docs/tasks/looks/CORR-LOOKS-071.md) | Hold the rule's pen advance against the game, not only the uv | LOOKS-TASK-37 | high | pending | — |
| [CORR-LOOKS-072](/docs/tasks/looks/CORR-LOOKS-072.md) | Say 'within 16 per channel', not 'pixel a pixel', for the labels | LOOKS-TASK-37 | medium | pending | — |
