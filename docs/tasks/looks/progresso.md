...
| [LOOKS-TASK-37](/docs/tasks/looks/37-a-tabela-de-glifos.md) | A tabela de glifos — o texto da tela desenhado com a fonte do `EDT_2D.BIN` | 10 | implementação | LOOKS-TASK-31 | done | 2026-09-22 | pending |
