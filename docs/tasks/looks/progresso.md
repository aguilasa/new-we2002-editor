...
| [LOOKS-TASK-02](/docs/tasks/looks/02-ambiente-e-os-dois-discos.md) | Ambiente — o venv, os dois discos e seus papéis, e a armadilha do MSYS | 0 | 01 | ✅ Concluído | 2026-09-14 | ⬜ pendente |
...
| [LOOKS-TASK-10](/docs/tasks/looks/10-lista-de-cluts-do-dat2d.md) | A lista de CLUTs do `DAT2D.BIN` que o `bin_archive.py` não acha | 3 | 08 | ⬜ Pendente | — | — |
| [LOOKS-TASK-11](/docs/tasks/looks/11-qual-imagem-e-o-cabelo.md) | A contradição 8 × 3.568 — qual imagem do `DAT2D.BIN` é o cabelo | 3 | 10 | ⬜ Pendente | — | — |
| [LOOKS-TASK-12](/docs/tasks/looks/12-pele-paleta-ou-vertice.md) | Incógnita (d) — pele é troca de paleta ou de cor de vértice? | 3 | 11 | ⬜ Pendente | — | — |
| [LOOKS-TASK-13](/docs/tasks/looks/13-campos-e-dominios-de-looks.md) | `looks.py` — os doze campos, seus domínios e os rótulos | 4 | 09 | ⬜ Pendente | — | — |
...
- [ ] `route_looks()` chega à tela sozinha e deixa save state.
- [ ] A incógnita (a) tem veredito com evidência.
- [ ] As onze peças têm nome, e ao lado como se soube.

### Fase 3 — textura

- [ ] A lista de CLUTs do `DAT2D.BIN` é achada por marcador.
- [ ] A contradição 8 × 3.568 tem veredito.
- [ ] A incógnita (d) diz o que o renderizador tem de implementar.

### Fase 4 — montagem

- [ ] Os doze campos com domínio conferido contra `src/core/Player.cpp`.
