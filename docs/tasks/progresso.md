...
| [WTE-TASK-03](/docs/tasks/03-extrator-de-dfm.md) | `dfm_extract.py` — os 18 formulários | 1 | 02 | ✅ Concluído | 2026-08-05 | ⬜ pendente |
...
- [ ] Limite da tabela de offsets **medido**, não estimado
- [ ] Offsets que o `newWe2002` não tem, listados
...
- [ ] Gabarito de spec com o campo **evidência**, e a proibição de colar decompilado
