...
lacuna que a [CORR-WTE-123](/docs/tasks/CORR-WTE-123.md) fechou para a §8.1. Os
...
- `docs/tasks/PAR-TASK-03.md` — os itens, a Definição de pronto, o `status` e o
  adendo no Log
- `docs/tasks/progresso.md` — a linha da PAR-TASK-03 no anexo
