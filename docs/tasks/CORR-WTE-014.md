...
[WTE-TASK-09](/docs/tasks/09-fechamento-fase-1.md). Só que o **quadro de
...
[CORR-WTE-012](/docs/tasks/CORR-WTE-012.md), aberta na revisão da WTE-TASK-07
...
| Arquivo | Ação |
|---|---|
| `docs/tasks/09-fechamento-fase-1.md` | modificar |
