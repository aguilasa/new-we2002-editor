...
fase 6 e depende da [WTE-TASK-34](/docs/tasks/34-bateria-golden-completa.md),
que depende da [WTE-TASK-31](/docs/tasks/31-fechamento-fase-4.md), que exige
nenhum `aberto`. Esperar a 37 travava as três para sempre.

## Evidência

**`flechasapaClick`** — a [CORR-WTE-063](/docs/tasks/CORR-WTE-063.md) fechou em
2026-08-18 levando as três carregadoras de bitmap (`0x00406fe0`, `0x00407110`,
`0x00407338`) para a [WTE-TASK-35](/docs/tasks/35-divergencias-deliberadas.md)
...
[CORR-WTE-089](/docs/tasks/CORR-WTE-089.md) confirma: **zero** linha nos 16
roteiros.
...
| `docs/tasks/progresso.md`, `docs/tasks/correcoes-progresso.md` | modificar |
...
- **Arquivos:** as três specs, `wte/tools/cobertura_gate.py`,
  `wte/tools/test_cobertura_gate.py`, este arquivo, `docs/tasks/progresso.md`,
  `docs/tasks/correcoes-progresso.md`, e regerados `wte/re/fase-4.md` e
