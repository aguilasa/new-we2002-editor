...
| [MCR-TASK-17](/docs/tasks/port-mcr/17-mapa-dos-desbloqueios.md) | Onde o option file guarda os times secretos e a Master League no modo exibição | 5 | 09 | ✅ Concluído | 2026-09-10 | ⬜ pendente |
