...
[CORR-WTE-006](/docs/tasks/CORR-WTE-006.md) e da
[CORR-WTE-009](/docs/tasks/CORR-WTE-009.md): a medição existe, o documento que
...
### Arquivo: `docs/tasks/06-mapa-de-offsets.md`
...
[WTE-TASK-09](/docs/tasks/09-fechamento-fase-1.md) tem no quadro de
...
| `docs/tasks/06-mapa-de-offsets.md` | modificar — enunciado, linha 45 |
