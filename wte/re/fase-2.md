...
| Escrito à mão | 23 | 1055 |
| **Total** | | **10235** |

**89.7% do Pascal da casca é saída de gerador.**
...
| `src/impl/ep2002_mainform.lista_equiposChange.inc` | 122 | corpo de handler, da spec (fase 4) |
...
fração sobe para 97.1% — e passa a medir bitmap, não geração de código.
