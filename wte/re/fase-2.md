...
| Escrito à mão | 44 | 2249 |
| **Total** | | **11346** |

**80.2% do Pascal da casca é saída de gerador.**
...
| `src/impl/ep2002_mainform.aux.inc` | 737 | corpo de handler, da spec (fase 4) |
...
fração sobe para 93.9% — e passa a medir bitmap, não geração de código.
