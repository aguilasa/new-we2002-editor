...
Produto da [WTE-TASK-14](../../docs/tasks/concluidos/14-fechamento-fase-2.md). **Gerado** por
...
| Escrito à mão | 106 | 9155 |
| **Total** | | **18608** |

**50.8% do Pascal da casca é saída de gerador.**
...
| `src/impl/ep2002_jugador.BitBtn1Click.inc` | 33 | corpo de handler, da spec (fase 4) |
...
| `src/impl/ep2002_mainform.FormShow.inc` | 153 | corpo de handler, da spec (fase 4) |
...
| `src/impl/ep2002_mainform.aux.inc` | 1306 | corpo de handler, da spec (fase 4) |
...
| `src/impl/ep2002_mainform.lista_equiposChange.inc` | 199 | corpo de handler, da spec (fase 4) |
...
fração sobe para 79.3% — e passa a medir bitmap, não geração de código.
...
| Pendência | Para quem |
|---|---|
| O oráculo quebra ao selecionar um time (310 `EXCEPTION_ACCESS_VIOLATION`) | [WTE-TASK-22](../../docs/tasks/concluidos/22-harness-golden.md), **bloqueante** |
| Aceitar o aviso de tamanho grava 11.952 bytes na imagem | [WTE-TASK-22](../../docs/tasks/concluidos/22-harness-golden.md) |
| Teclado não chega ao app LCL no `:99` | [WTE-TASK-22](../../docs/tasks/concluidos/22-harness-golden.md) |
| Cor de fundo posta em tempo de execução | [WTE-TASK-25](../../docs/tasks/concluidos/25-handlers-de-carga.md) |
| As 14 capturas do original | [WTE-TASK-37](../../docs/tasks/concluidos/37-reconferencia-de-ui.md) |
