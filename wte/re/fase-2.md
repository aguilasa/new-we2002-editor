...
|---|---|---|
| Unidades Pascal geradas (`dfm2lfm.py`) | 21 | 2551 |
| Formulários `.lfm`, estrutura | 18 | 6768 |
| **Gerado, subtotal** | | **9319** |
| Escrito à mão | 59 | 3622 |
| **Total** | | **12941** |

**72.0% do Pascal da casca é saída de gerador.**
...
| `src/impl/ep2002_mainform.aux.inc` | 1176 | corpo de handler, da spec (fase 4) |
...
fração sobe para 90.6% — e passa a medir bitmap, não geração de código.
