...
| Escrito à mão | 28 | 1276 |
| **Total** | | **10436** |

**87.8% do Pascal da casca é saída de gerador.**
...
| `src/impl/ep2002_mainform.aux.inc` | 280 | corpo de handler, da spec (fase 4) |
...
fração sobe para 96.5% — e passa a medir bitmap, não geração de código.
