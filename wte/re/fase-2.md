...
|---|---|---|
| Unidades Pascal geradas (`dfm2lfm.py`) | 21 | 2547 |
| Formulários `.lfm`, estrutura | 18 | 6768 |
| **Gerado, subtotal** | | **9315** |
| Escrito à mão | 60 | 3726 |
| **Total** | | **13041** |

**71.4% do Pascal da casca é saída de gerador.**
...
| `src/impl/ep2002_mainform.FormShow.inc` | 102 | corpo de handler, da spec (fase 4) |
| `src/impl/ep2002_mainform.aux.inc` | 1184 | corpo de handler, da spec (fase 4) |
...
fração sobe para 90.4% — e passa a medir bitmap, não geração de código.
