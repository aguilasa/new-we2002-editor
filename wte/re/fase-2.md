...
|---|---|---|
| Unidades Pascal geradas (`dfm2lfm.py`) | 18 | 2415 |
| Formulários `.lfm`, estrutura | 18 | 6768 |
| **Gerado, subtotal** | | **9183** |
| Escrito à mão | 22 | 787 |
| **Total** | | **9970** |

**92.1% do Pascal da casca é saída de gerador.**
...
| `src/impl/ep2002_mainform.aux.inc` | 76 | corpo de handler, da spec (fase 4) |
...
fração sobe para 97.8% — e passa a medir bitmap, não geração de código.
