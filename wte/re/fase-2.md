...
| `src/impl/ep2002_mainform.base_teamClick.inc` | 118 | corpo de handler, da spec (fase 4) |
...
fração sobe para 80.1% — e passa a medir bitmap, não geração de código.
