...
| Escrito à mão | 61 | 4011 |
| **Total** | | **13322** |

**69.9% do Pascal da casca é saída de gerador.**
...
| `src/impl/ep2002_mainform.aux.inc` | 1413 | corpo de handler, da spec (fase 4) |
...
fração sobe para 89.7% — e passa a medir bitmap, não geração de código.
