...
|---|---|---|
| Unidades Pascal geradas (`dfm2lfm.py`) | 19 | 2396 |
| Formulários `.lfm`, estrutura | 18 | 6768 |
| **Gerado, subtotal** | | **9164** |
| Escrito à mão | 48 | 2568 |
| **Total** | | **11732** |

**78.1% do Pascal da casca é saída de gerador.**
...
fração sobe para 93.1% — e passa a medir bitmap, não geração de código.
