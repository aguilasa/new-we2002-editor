...
| Escrito à mão | 61 | 4146 |
| **Total** | | **13457** |

**69.2% do Pascal da casca é saída de gerador.**
...
| `src/impl/ep2002_mainform.aux.inc` | 1542 | corpo de handler, da spec (fase 4) |
...
fração sobe para 89.4% — e passa a medir bitmap, não geração de código.
