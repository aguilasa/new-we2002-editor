object ficha_salida: Tficha_salida
  Left = 187
  Top = 169
  AlphaBlend = True
  AlphaBlendValue = 245
  BorderStyle = bsSingle
  Caption = 'Fechar W11TE'
  ClientHeight = 90
  ClientWidth = 225
  Color = clBtnFace
  ...
  Font.Style = []
  Icon.Data = {blob ficha_salida.Icon.Data.bin 318 sha256:bdcd57af2aedffc5591198d89b55b6adf4f295bbc3dcfbc71afca377edf6d471}
  ...
  object etiq1: TLabel
    ...
    Height = 16
    Alignment = taCenter
    Caption = 'Voce deseja realmente sair?     '
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'MS Sans Serif'
