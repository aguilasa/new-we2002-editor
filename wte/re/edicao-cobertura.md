...
| `iguala_nombresClick` | outra_task | `WTE-TASK-35` | o clique copia e trunca; o botao nao acinzenta no port porque o glifo e invariante sob o `gdeDisabled` da LCL, que e grayscale -- causa medida pela CORR-WTE-060, divergencia deliberada, travada pelo `check_glifos_disabled.py` |
