...
Filtro de tecla do segundo campo de nome do time. 88 bytes.
...
```text
se Key = #13:  edit_nombre3.SetFocus        ' VMT slot 0xc0
...
Pascal em
[`../../src/impl/ep2002_mainform.edit_nombre2KeyPress.inc`](../../src/impl/ep2002_mainform.edit_nombre2KeyPress.inc).
