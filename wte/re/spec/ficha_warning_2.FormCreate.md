...
`Color := $003C3CDC` sobre o próprio formulário — RGB(220, 60, 60).
...
O Pascal está em [`../../src/impl/ep2002_warning_2.FormCreate.inc`](../../src/impl/ep2002_warning_2.FormCreate.inc).
