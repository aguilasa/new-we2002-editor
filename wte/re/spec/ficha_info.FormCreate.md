...
`Color := $00DCDC3C` sobre o próprio formulário — RGB(60, 220, 220).

O DFM declara `Color = clSilver`, e **essa cor nunca aparece na tela**: o
...
O Pascal está em [`../../src/impl/ep2002_info.FormCreate.inc`](../../src/impl/ep2002_info.FormCreate.inc).
