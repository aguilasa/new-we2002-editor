{ Esqueleto gerado por `wte/tools/dfm2lfm.py` (WTE-TASK-10).
  ...
  Formulario `ficha_info3`, classe `Tficha_info3`.
  Origem: `wte/re/dfm/ficha_info3.dfm`.
  2 componentes, 1 handlers publicados.
...
var
  ficha_info3: Tficha_info3;

implementation

{$R ../forms/ep2002_info3.lfm}

procedure Tficha_info3.FormCreate(Sender: TObject);
{$I impl/ep2002_info3.FormCreate.inc}
