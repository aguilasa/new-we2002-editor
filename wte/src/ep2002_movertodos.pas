{ Esqueleto gerado por `wte/tools/dfm2lfm.py` (WTE-TASK-10).
  ...
  Formulario `ficha_movertodos`, classe `Tficha_movertodos`.
  Origem: `wte/re/dfm/ficha_movertodos.dfm`.
...
var
  ficha_movertodos: Tficha_movertodos;

implementation

{$R ../forms/ep2002_movertodos.lfm}

procedure Tficha_movertodos.FormCreate(Sender: TObject);
{$I impl/ep2002_movertodos.FormCreate.inc}
