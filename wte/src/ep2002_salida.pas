{ Esqueleto gerado por `wte/tools/dfm2lfm.py` (WTE-TASK-10).
  ...
  Formulario `ficha_salida`, classe `Tficha_salida`.
  Origem: `wte/re/dfm/ficha_salida.dfm`.
...
var
  ficha_salida: Tficha_salida;

implementation

{$R ../forms/ep2002_salida.lfm}

procedure Tficha_salida.FormCreate(Sender: TObject);
{$I impl/ep2002_salida.FormCreate.inc}
