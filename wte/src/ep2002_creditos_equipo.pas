{ Esqueleto gerado por `wte/tools/dfm2lfm.py` (WTE-TASK-10).
  ...
  Formulario `ficha_creditos_equipo`, classe `Tficha_creditos_equipo`.
  Origem: `wte/re/dfm/ficha_creditos_equipo.dfm`.
  3 componentes, 1 handlers publicados.
...
type
  Tficha_creditos_equipo = class(TForm)
    {
...
var
  ficha_creditos_equipo: Tficha_creditos_equipo;

implementation

{$R ../forms/ep2002_creditos_equipo.lfm}

procedure Tficha_creditos_equipo.FormCreate(Sender: TObject);
{$I impl/ep2002_creditos_equipo.FormCreate.inc}
