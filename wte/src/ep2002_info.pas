{ Esqueleto gerado por `wte/tools/dfm2lfm.py` (WTE-TASK-10).
  ...
  Formulario `ficha_info`, classe `Tficha_info`.
  Origem: `wte/re/dfm/ficha_info.dfm`.
...
var
  ficha_info: Tficha_info;

implementation

{$R ../forms/ep2002_info.lfm}

procedure Tficha_info.FormCreate(Sender: TObject);
{$I impl/ep2002_info.FormCreate.inc}
