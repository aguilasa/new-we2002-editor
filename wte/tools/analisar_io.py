...
def gerar() -> str:
    ...
    w("truncar a que temos não serve. Sobraram dois caminhos, e a")
    w("[`crash.md`](crash.md) mudou qual deles é o curto — uma release cuja")
    w("região em `14368636` seja populada, **ou** descobrir por que o")
    w("controle que a rotina procura não existe, que é pergunta para a fase 4")
    w("sobre um manipulador que já tem nome e endereço.")
    w("")
    ...
    w("gate nenhum. **Fazer o `wte.exe` passar da tela de carga deixou de ser")
    w("desejável e passou a ser pré-requisito da fase 4** — por qualquer dos")
    w("dois caminhos acima.")
    w("")
    w("---")
    w("")
