...
def gera_md(medidas: list[dict], base: int) -> str:
    ...
    a("")
    a(f"Produto da [WTE-TASK-25](../../docs/tasks/concluidos/25-handlers-de-carga.md).")
    ...
    a("[`../../docs/tasks/concluidos/progresso.md`](../../docs/tasks/concluidos/progresso.md) por outro")
    a("caminho.")
    a("")
    ...
    a("[WTE-TASK-04](../../docs/tasks/concluidos/04-mapa-de-handlers.md) (-52).")
    a("")
    a("```text")
    a("word  contagem")
