...
def gera(m: dict) -> str:
    ...
    a("```")
    a("")
    a("Produto da [WTE-TASK-34](../../docs/tasks/concluidos/34-bateria-golden-completa.md).")
    ...
    a("[WTE-TASK-31](../../docs/tasks/concluidos/31-fechamento-fase-4.md): se os dois")
    ...
    a("que a [CORR-WTE-104](../../docs/tasks/concluidos/CORR-WTE-104.md) achou. O roteiro")
    ...
    a("[WTE-TASK-35](../../docs/tasks/concluidos/35-divergencias-deliberadas.md) como")
