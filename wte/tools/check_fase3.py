...
def gerar() -> str:
    ...
    w(f"**Gerado por [`{GENERATOR}`](../tools/check_fase3.py) — não editar à "
      f"mão.**")
    w("")
    w("Produto da [WTE-TASK-21](../../docs/tasks/21-fechamento-fase-3.md). O")
    ...
    if casca:
        ...
        w("[WTE-TASK-22](../../docs/tasks/22-harness-golden.md) antes da")
        w("[WTE-TASK-25](../../docs/tasks/25-handlers-de-carga.md). Fazer a")
    ...
    w("[WTE-TASK-24](../../docs/tasks/24-ghidra-convencao-borland.md), que é")
    ...
    w("  a [WTE-TASK-19](../../docs/tasks/19-os-50-offsets-restantes.md)")
