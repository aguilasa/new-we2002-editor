# PARIDADE-FUNCIONAL §8.1, item 4 (metade "seleção") -- CMD_COPY_TEAM_NAMES.
#
# Time: Nation 1 - Ireland.
# Estímulo: escrever no TXT_TEAM_NAME1 e clicar no "copy" (75,17,34,10), que
# espalha o 1º nome pelos outros slots truncando em cada limite, e deriva daí
# a caixa mista e a grafia kanji -- é onde o quirk de comprimento do kanji
# (§3.3) aparece.
#
...
# o clique no botão já tira o foco do campo, então o killfocus grava antes de
# o handler ler o texto
