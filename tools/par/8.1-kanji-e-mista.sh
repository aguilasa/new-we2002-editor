# PARIDADE-FUNCIONAL §8.1, item 2 -- nome kanji e nome em caixa mista.
#
# Time: Nation 1 - Ireland.
# Estímulo: TXT_TEAM_NAME_KANJI (10,123) e TXT_TEAM_NAME_MIXED (10,109).
# O campo kanji passa pelo asciitokanji, então a faixa gravada é MAIOR que o
# número de caracteres digitados -- é o ponto do item.
#
...
par_click 10 123 76 12; sleep 1     # TXT_TEAM_NAME_KANJI
par_type "GOLDENK"
par_click 10 109 76 12; sleep 1     # TXT_TEAM_NAME_MIXED
par_type "GoldenM"
