# PARIDADE-FUNCIONAL §8.3, item 2 -- escolher com Return e sair com Tab.
#
# Time: Nation 1 - Ireland.
# Estímulo: abrir o CMB_KICK_LONG_FK, dois `Down`, `Return` para escolher, e
# `Tab` para tirar o foco. O campo vale 3 na imagem, então duas descidas dão 5,
# e os outros cinco cobradores têm de ficar intactos.
#
# Este é o irmão que já passava antes da CORR-WTE-125, e serve de guarda: o
# conserto do Escape não pode quebrá-lo.
#
...
xdotool key --clearmodifiers Down;   sleep 1
xdotool key --clearmodifiers Return; sleep 2
xdotool key --clearmodifiers Tab;    sleep 2
