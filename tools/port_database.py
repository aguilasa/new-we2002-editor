...
def main() -> int:
    ...
    # newline="\n" is not decoration: without it Python's text layer turns every
    # '\n' into '\r\n' on Windows, and the generated source would differ from
    # the committed one by a carriage return per line. See docs/PLAN-WINDOWS.md,
    # task T1.
